(ns clojure-kubernetes-client.specs.v1beta1-stateful-set-spec
...
(declare v1beta1-stateful-set-spec-data v1beta1-stateful-set-spec)
(def v1beta1-stateful-set-spec-data
  {
   ...
   (ds/opt :updateStrategy) v1beta1-stateful-set-update-strategy
   (ds/opt :volumeClaimTemplates) (s/coll-of v1-persistent-volume-claim)
   })

(def v1beta1-stateful-set-spec
  (ds/spec
    {:name ::v1beta1-stateful-set-spec
     :spec v1beta1-stateful-set-spec-data}))
