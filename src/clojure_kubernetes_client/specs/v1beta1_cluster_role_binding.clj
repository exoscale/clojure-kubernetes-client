(ns clojure-kubernetes-client.specs.v1beta1-cluster-role-binding
...
(declare v1beta1-cluster-role-binding-data v1beta1-cluster-role-binding)
...
(def v1beta1-cluster-role-binding
  (ds/spec
