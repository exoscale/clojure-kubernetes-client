(ns clojure-kubernetes-client.specs.v1beta2-daemon-set-status
...
(declare v1beta2-daemon-set-status-data v1beta2-daemon-set-status)
(def v1beta2-daemon-set-status-data
  {
   (ds/opt :collisionCount) int?
   (ds/opt :conditions) (s/coll-of v1beta2-daemon-set-condition)
...
(def v1beta2-daemon-set-status
  (ds/spec
    {:name ::v1beta2-daemon-set-status
     :spec v1beta2-daemon-set-status-data}))
