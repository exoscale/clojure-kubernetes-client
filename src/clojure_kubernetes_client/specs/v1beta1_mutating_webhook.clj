(ns clojure-kubernetes-client.specs.v1beta1-mutating-webhook
...
(declare v1beta1-mutating-webhook-data v1beta1-mutating-webhook)
(def v1beta1-mutating-webhook-data
  {
...
(def v1beta1-mutating-webhook
  (ds/spec
    {:name ::v1beta1-mutating-webhook
     :spec v1beta1-mutating-webhook-data}))
