(ns clojure-kubernetes-client.specs.v1beta1-daemon-set
...
(declare v1beta1-daemon-set-data v1beta1-daemon-set)
(def v1beta1-daemon-set-data
  {
   (ds/opt :apiVersion) string?
   (ds/opt :kind) string?
   (ds/opt :metadata) v1-object-meta
   (ds/opt :spec) v1beta1-daemon-set-spec
   (ds/opt :status) v1beta1-daemon-set-status
   })

(def v1beta1-daemon-set
  (ds/spec
