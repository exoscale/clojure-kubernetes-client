...
(declare v1beta1-json-schema-props-data v1beta1-json-schema-props)
(def v1beta1-json-schema-props-data
  {
   ...
   (ds/opt :allOf) (s/coll-of v1beta1-json-schema-props)
   (ds/opt :anyOf) (s/coll-of v1beta1-json-schema-props)
   (ds/opt :default) any?
   (ds/opt :definitions) (s/map-of string? v1beta1-json-schema-props)
   ...
   (ds/opt :externalDocs) v1beta1-external-documentation
   ...
   (ds/opt :not) v1beta1-json-schema-props
   (ds/opt :nullable) boolean?
   (ds/opt :oneOf) (s/coll-of v1beta1-json-schema-props)
   (ds/opt :pattern) string?
   (ds/opt :patternProperties) (s/map-of string? v1beta1-json-schema-props)
   (ds/opt :properties) (s/map-of string? v1beta1-json-schema-props)
