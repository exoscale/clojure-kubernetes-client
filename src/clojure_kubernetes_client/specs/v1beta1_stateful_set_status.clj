(ns clojure-kubernetes-client.specs.v1beta1-stateful-set-status
...
(declare v1beta1-stateful-set-status-data v1beta1-stateful-set-status)
(def v1beta1-stateful-set-status-data
  {
   (ds/opt :collisionCount) int?
   (ds/opt :conditions) (s/coll-of v1beta1-stateful-set-condition)
...
(def v1beta1-stateful-set-status
  (ds/spec
