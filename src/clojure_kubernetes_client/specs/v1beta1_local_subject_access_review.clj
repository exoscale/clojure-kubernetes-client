(ns clojure-kubernetes-client.specs.v1beta1-local-subject-access-review
...
(declare v1beta1-local-subject-access-review-data v1beta1-local-subject-access-review)
...
(def v1beta1-local-subject-access-review
  (ds/spec
