(ns clojure-kubernetes-client.specs.v2beta2-pods-metric-status
...
(declare v2beta2-pods-metric-status-data v2beta2-pods-metric-status)
...
(def v2beta2-pods-metric-status
  (ds/spec
