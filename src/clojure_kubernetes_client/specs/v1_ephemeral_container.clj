(ns clojure-kubernetes-client.specs.v1-ephemeral-container
...
(declare v1-ephemeral-container-data v1-ephemeral-container)
(def v1-ephemeral-container-data
  {
   ...
   (ds/opt :targetContainerName) string?
...
(def v1-ephemeral-container
  (ds/spec
    {:name ::v1-ephemeral-container
     :spec v1-ephemeral-container-data}))
