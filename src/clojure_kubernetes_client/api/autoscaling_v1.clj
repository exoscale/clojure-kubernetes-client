(ns clojure-kubernetes-client.api.autoscaling-v1
...
(defn-spec create-namespaced-horizontal-pod-autoscaler v1-horizontal-pod-autoscaler
  "
  create a HorizontalPodAutoscaler"
  ...
  ([namespace string?, body v1-horizontal-pod-autoscaler, optional-params any?]
   (let [res (:data (create-namespaced-horizontal-pod-autoscaler-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-horizontal-pod-autoscaler res st/string-transformer)
        res))))
...
(defn-spec list-horizontal-pod-autoscaler-for-all-namespaces v1-horizontal-pod-autoscaler-list
  "
  list or watch objects of kind HorizontalPodAutoscaler"
  ...
  ([optional-params any?]
   (let [res (:data (list-horizontal-pod-autoscaler-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-horizontal-pod-autoscaler-list res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-horizontal-pod-autoscaler v1-horizontal-pod-autoscaler-list
  "
  list or watch objects of kind HorizontalPodAutoscaler"
...
(defn-spec patch-namespaced-horizontal-pod-autoscaler v1-horizontal-pod-autoscaler
  "
  partially update the specified HorizontalPodAutoscaler"
...
(defn-spec patch-namespaced-horizontal-pod-autoscaler-status v1-horizontal-pod-autoscaler
  "
  partially update status of the specified HorizontalPodAutoscaler"
...
(defn-spec read-namespaced-horizontal-pod-autoscaler v1-horizontal-pod-autoscaler
  "
  read the specified HorizontalPodAutoscaler"
...
(defn-spec read-namespaced-horizontal-pod-autoscaler-status v1-horizontal-pod-autoscaler
  "
  read status of the specified HorizontalPodAutoscaler"
...
(defn-spec replace-namespaced-horizontal-pod-autoscaler v1-horizontal-pod-autoscaler
  "
  replace the specified HorizontalPodAutoscaler"
...
(defn-spec replace-namespaced-horizontal-pod-autoscaler-status v1-horizontal-pod-autoscaler
  "
  replace status of the specified HorizontalPodAutoscaler"
