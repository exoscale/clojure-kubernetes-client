(ns clojure-kubernetes-client.api.scheduling-v1beta1
...
(defn-spec create-priority-class v1beta1-priority-class
  "
  create a PriorityClass"
  ...
  ([body v1beta1-priority-class, optional-params any?]
   (let [res (:data (create-priority-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-priority-class res st/string-transformer)
        res))))
...
(defn-spec list-priority-class v1beta1-priority-class-list
  "
  list or watch objects of kind PriorityClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-priority-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-priority-class-list res st/string-transformer)
        res))))
...
(defn-spec patch-priority-class v1beta1-priority-class
  "
  partially update the specified PriorityClass"
...
(defn-spec read-priority-class v1beta1-priority-class
  "
  read the specified PriorityClass"
...
(defn-spec replace-priority-class v1beta1-priority-class
  "
  replace the specified PriorityClass"
