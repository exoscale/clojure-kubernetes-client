(ns clojure-kubernetes-client.api.coordination-v1
...
(defn-spec create-namespaced-lease v1-lease
  "
  create a Lease"
  ...
  ([namespace string?, body v1-lease, optional-params any?]
   (let [res (:data (create-namespaced-lease-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-lease res st/string-transformer)
        res))))
...
(defn-spec list-lease-for-all-namespaces v1-lease-list
  "
  list or watch objects of kind Lease"
  ...
  ([optional-params any?]
   (let [res (:data (list-lease-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-lease-list res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-lease v1-lease-list
  "
  list or watch objects of kind Lease"
...
(defn-spec patch-namespaced-lease v1-lease
  "
  partially update the specified Lease"
...
(defn-spec read-namespaced-lease v1-lease
  "
  read the specified Lease"
...
(defn-spec replace-namespaced-lease v1-lease
  "
  replace the specified Lease"
