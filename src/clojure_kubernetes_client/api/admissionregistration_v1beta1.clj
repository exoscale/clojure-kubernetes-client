(ns clojure-kubernetes-client.api.admissionregistration-v1beta1
...
(defn-spec create-mutating-webhook-configuration v1beta1-mutating-webhook-configuration
  "
  create a MutatingWebhookConfiguration"
  ...
  ([body v1beta1-mutating-webhook-configuration, optional-params any?]
   (let [res (:data (create-mutating-webhook-configuration-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-mutating-webhook-configuration res st/string-transformer)
        res))))
...
(defn-spec create-validating-webhook-configuration v1beta1-validating-webhook-configuration
  "
  create a ValidatingWebhookConfiguration"
  ...
  ([body v1beta1-validating-webhook-configuration, optional-params any?]
   (let [res (:data (create-validating-webhook-configuration-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-validating-webhook-configuration res st/string-transformer)
        res))))
...
(defn-spec list-mutating-webhook-configuration v1beta1-mutating-webhook-configuration-list
  "
  list or watch objects of kind MutatingWebhookConfiguration"
  ...
  ([optional-params any?]
   (let [res (:data (list-mutating-webhook-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-mutating-webhook-configuration-list res st/string-transformer)
        res))))
...
(defn-spec list-validating-webhook-configuration v1beta1-validating-webhook-configuration-list
  "
  list or watch objects of kind ValidatingWebhookConfiguration"
  ...
  ([optional-params any?]
   (let [res (:data (list-validating-webhook-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-validating-webhook-configuration-list res st/string-transformer)
        res))))
...
(defn-spec patch-mutating-webhook-configuration v1beta1-mutating-webhook-configuration
  "
  partially update the specified MutatingWebhookConfiguration"
...
(defn-spec patch-validating-webhook-configuration v1beta1-validating-webhook-configuration
  "
  partially update the specified ValidatingWebhookConfiguration"
...
(defn-spec read-mutating-webhook-configuration v1beta1-mutating-webhook-configuration
  "
  read the specified MutatingWebhookConfiguration"
...
(defn-spec read-validating-webhook-configuration v1beta1-validating-webhook-configuration
  "
  read the specified ValidatingWebhookConfiguration"
...
(defn-spec replace-mutating-webhook-configuration v1beta1-mutating-webhook-configuration
  "
  replace the specified MutatingWebhookConfiguration"
...
(defn-spec replace-validating-webhook-configuration v1beta1-validating-webhook-configuration
  "
  replace the specified ValidatingWebhookConfiguration"
