(ns clojure-kubernetes-client.api.apiregistration-v1
...
(defn-spec create-api-service v1-api-service
  "
  create an APIService"
  ...
  ([body v1-api-service, optional-params any?]
   (let [res (:data (create-api-service-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-api-service res st/string-transformer)
        res))))
...
(defn-spec list-api-service v1-api-service-list
  "
  list or watch objects of kind APIService"
  ...
  ([optional-params any?]
   (let [res (:data (list-api-service-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-api-service-list res st/string-transformer)
        res))))
...
(defn-spec patch-api-service v1-api-service
  "
  partially update the specified APIService"
...
(defn-spec patch-api-service-status v1-api-service
  "
  partially update status of the specified APIService"
...
(defn-spec read-api-service v1-api-service
  "
  read the specified APIService"
...
(defn-spec read-api-service-status v1-api-service
  "
  read status of the specified APIService"
...
(defn-spec replace-api-service v1-api-service
  "
  replace the specified APIService"
...
(defn-spec replace-api-service-status v1-api-service
  "
  replace status of the specified APIService"
