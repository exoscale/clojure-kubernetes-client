(ns clojure-kubernetes-client.api.batch-v1beta1
...
(defn-spec create-namespaced-cron-job v1beta1-cron-job
  "
  create a CronJob"
  ...
  ([namespace string?, body v1beta1-cron-job, optional-params any?]
   (let [res (:data (create-namespaced-cron-job-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-cron-job res st/string-transformer)
        res))))
...
(defn-spec list-cron-job-for-all-namespaces v1beta1-cron-job-list
  "
  list or watch objects of kind CronJob"
  ...
  ([optional-params any?]
   (let [res (:data (list-cron-job-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-cron-job-list res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-cron-job v1beta1-cron-job-list
  "
  list or watch objects of kind CronJob"
...
(defn-spec patch-namespaced-cron-job v1beta1-cron-job
  "
  partially update the specified CronJob"
...
(defn-spec patch-namespaced-cron-job-status v1beta1-cron-job
  "
  partially update status of the specified CronJob"
...
(defn-spec read-namespaced-cron-job v1beta1-cron-job
  "
  read the specified CronJob"
...
(defn-spec read-namespaced-cron-job-status v1beta1-cron-job
  "
  read status of the specified CronJob"
...
(defn-spec replace-namespaced-cron-job v1beta1-cron-job
  "
  replace the specified CronJob"
...
(defn-spec replace-namespaced-cron-job-status v1beta1-cron-job
  "
  replace status of the specified CronJob"
