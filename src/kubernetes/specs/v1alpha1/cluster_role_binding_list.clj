(ns kubernetes.specs.v1alpha1/cluster-role-binding-list
...
(def v1alpha1/cluster-role-binding-list-data
  {
   ...
   (ds/req :items) (s/coll-of v1alpha1/cluster-role-binding-spec)
   (ds/opt :kind) string?
   (ds/opt :metadata) v1/list-meta-spec
   })

(def v1alpha1/cluster-role-binding-list-spec
  (ds/spec
