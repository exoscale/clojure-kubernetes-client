(ns kubernetes.specs.v1beta1/cluster-role-binding-list
...
(def v1beta1/cluster-role-binding-list-data
  {
   ...
   (ds/req :items) (s/coll-of v1beta1/cluster-role-binding-spec)
   (ds/opt :kind) string?
   (ds/opt :metadata) v1/list-meta-spec
   })

(def v1beta1/cluster-role-binding-list-spec
  (ds/spec
