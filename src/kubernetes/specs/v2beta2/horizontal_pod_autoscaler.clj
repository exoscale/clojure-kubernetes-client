(ns kubernetes.specs.v2beta2/horizontal-pod-autoscaler
...
(def v2beta2/horizontal-pod-autoscaler-data
  {
   ...
   (ds/opt :spec) v2beta2/horizontal-pod-autoscaler-spec-spec
   (ds/opt :status) v2beta2/horizontal-pod-autoscaler-status-spec
   })
