(ns kubernetes.specs.v1/network-policy-ingress-rule
...
(def v1/network-policy-ingress-rule-data
  {
   (ds/opt :from) (s/coll-of v1/network-policy-peer-spec)
   (ds/opt :ports) (s/coll-of v1/network-policy-port-spec)
   })

(def v1/network-policy-ingress-rule-spec
  (ds/spec
