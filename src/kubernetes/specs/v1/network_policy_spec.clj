(ns kubernetes.specs.v1/network-policy-spec
...
(def v1/network-policy-spec-data
  {
   (ds/opt :egress) (s/coll-of v1/network-policy-egress-rule-spec)
   (ds/opt :ingress) (s/coll-of v1/network-policy-ingress-rule-spec)
   (ds/req :podSelector) v1/label-selector-spec
   (ds/opt :policyTypes) (s/coll-of string?)
   })

(def v1/network-policy-spec-spec
  (ds/spec
