(ns kubernetes.specs.v1beta2/stateful-set-spec
...
(def v1beta2/stateful-set-spec-data
  {
   ...
   (ds/opt :updateStrategy) v1beta2/stateful-set-update-strategy-spec
   (ds/opt :volumeClaimTemplates) (s/coll-of v1/persistent-volume-claim-spec)
   })

(def v1beta2/stateful-set-spec-spec
  (ds/spec
    {:name ::v1beta2/stateful-set-spec
     :spec v1beta2/stateful-set-spec-data}))
