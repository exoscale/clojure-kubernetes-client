(ns kubernetes.specs.v2beta1/horizontal-pod-autoscaler-list
...
(def v2beta1/horizontal-pod-autoscaler-list-data
  {
   ...
   (ds/req :items) (s/coll-of v2beta1/horizontal-pod-autoscaler-spec)
   (ds/opt :kind) string?
   (ds/opt :metadata) v1/list-meta-spec
   })

(def v2beta1/horizontal-pod-autoscaler-list-spec
  (ds/spec
