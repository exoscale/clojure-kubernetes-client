...
(defn-spec create-storage-class-with-http-info any?
  ...
  ([body v1/storage-class, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec delete-storage-class-with-http-info any?
  ...
  ([name string?, body v1/delete-options, ] (delete-storage-class-with-http-info name body nil))
...
(defn-spec delete-storage-class v1/status-spec
  "
  delete a StorageClass"
  ([name string?, body v1/delete-options, ] (delete-storage-class name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-storage-class-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec replace-storage-class-with-http-info any?
  ...
  ([name string?, body v1/storage-class, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
