...
(defn-spec create-namespaced-horizontal-pod-autoscaler-with-http-info any?
  ...
  ([namespace string?, body v2beta1/horizontal-pod-autoscaler, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-horizontal-pod-autoscaler v2beta1/horizontal-pod-autoscaler-spec
  "
  create a HorizontalPodAutoscaler"
  ...
  ([namespace string?, body v2beta1/horizontal-pod-autoscaler, optional-params any?]
   (let [res (:data (create-namespaced-horizontal-pod-autoscaler-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v2beta1/horizontal-pod-autoscaler-spec res st/string-transformer)
        res))))
...
(defn-spec list-horizontal-pod-autoscaler-for-all-namespaces v2beta1/horizontal-pod-autoscaler-list-spec
  "
  list or watch objects of kind HorizontalPodAutoscaler"
  ...
  ([optional-params any?]
   (let [res (:data (list-horizontal-pod-autoscaler-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v2beta1/horizontal-pod-autoscaler-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-horizontal-pod-autoscaler v2beta1/horizontal-pod-autoscaler-list-spec
  "
  list or watch objects of kind HorizontalPodAutoscaler"
...
(defn-spec patch-namespaced-horizontal-pod-autoscaler v2beta1/horizontal-pod-autoscaler-spec
  "
  partially update the specified HorizontalPodAutoscaler"
...
(defn-spec patch-namespaced-horizontal-pod-autoscaler-status v2beta1/horizontal-pod-autoscaler-spec
  "
  partially update status of the specified HorizontalPodAutoscaler"
...
(defn-spec read-namespaced-horizontal-pod-autoscaler v2beta1/horizontal-pod-autoscaler-spec
  "
  read the specified HorizontalPodAutoscaler"
...
(defn-spec read-namespaced-horizontal-pod-autoscaler-status v2beta1/horizontal-pod-autoscaler-spec
  "
  read status of the specified HorizontalPodAutoscaler"
...
(defn-spec replace-namespaced-horizontal-pod-autoscaler-with-http-info any?
  ...
  ([name string?, namespace string?, body v2beta1/horizontal-pod-autoscaler, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-horizontal-pod-autoscaler v2beta1/horizontal-pod-autoscaler-spec
  "
  replace the specified HorizontalPodAutoscaler"
...
(defn-spec replace-namespaced-horizontal-pod-autoscaler-status v2beta1/horizontal-pod-autoscaler-spec
  "
  replace status of the specified HorizontalPodAutoscaler"
