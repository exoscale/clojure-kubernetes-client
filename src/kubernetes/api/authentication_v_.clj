...
(defn-spec create-token-review-with-http-info any?
  ...
  ([body v1/token-review, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-token-review v1/token-review-spec
  "
  create a TokenReview"
  ...
  ([body v1/token-review, optional-params any?]
   (let [res (:data (create-token-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/token-review-spec res st/string-transformer)
        res))))
