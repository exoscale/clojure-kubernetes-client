...
(defn-spec create-namespace-with-http-info any?
  ...
  ([body v1/namespace, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespace v1/namespace-spec
  "
  create a Namespace"
  ...
  ([body v1/namespace, optional-params any?]
   (let [res (:data (create-namespace-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/namespace-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-binding-with-http-info any?
  ...
  ([namespace string?, body v1/binding, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-binding v1/binding-spec
  "
  create a Binding"
  ...
  ([namespace string?, body v1/binding, optional-params any?]
   (let [res (:data (create-namespaced-binding-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/binding-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-config-map-with-http-info any?
  ...
  ([namespace string?, body v1/config-map, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-config-map v1/config-map-spec
  "
  create a ConfigMap"
  ...
  ([namespace string?, body v1/config-map, optional-params any?]
   (let [res (:data (create-namespaced-config-map-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/config-map-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-endpoints-with-http-info any?
  ...
  ([namespace string?, body v1/endpoints, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-endpoints v1/endpoints-spec
  "
  create Endpoints"
  ...
  ([namespace string?, body v1/endpoints, optional-params any?]
   (let [res (:data (create-namespaced-endpoints-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/endpoints-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-event-with-http-info any?
  ...
  ([namespace string?, body v1/event, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-event v1/event-spec
  "
  create an Event"
  ...
  ([namespace string?, body v1/event, optional-params any?]
   (let [res (:data (create-namespaced-event-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/event-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-limit-range-with-http-info any?
  ...
  ([namespace string?, body v1/limit-range, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-limit-range v1/limit-range-spec
  "
  create a LimitRange"
  ...
  ([namespace string?, body v1/limit-range, optional-params any?]
   (let [res (:data (create-namespaced-limit-range-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/limit-range-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-persistent-volume-claim-with-http-info any?
  ...
  ([namespace string?, body v1/persistent-volume-claim, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-persistent-volume-claim v1/persistent-volume-claim-spec
  "
  create a PersistentVolumeClaim"
  ...
  ([namespace string?, body v1/persistent-volume-claim, optional-params any?]
   (let [res (:data (create-namespaced-persistent-volume-claim-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/persistent-volume-claim-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-pod-with-http-info any?
  ...
  ([namespace string?, body v1/pod, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-pod v1/pod-spec
  "
  create a Pod"
  ...
  ([namespace string?, body v1/pod, optional-params any?]
   (let [res (:data (create-namespaced-pod-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/pod-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-pod-binding-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/binding, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-pod-binding v1/binding-spec
  "
  create binding of a Pod"
...
(defn-spec create-namespaced-pod-eviction-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/eviction, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec create-namespaced-pod-eviction v1beta1/eviction-spec
  "
  create eviction of a Pod"
  ...
  ([name string?, namespace string?, body v1beta1/eviction, optional-params any?]
   (let [res (:data (create-namespaced-pod-eviction-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/eviction-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-pod-template-with-http-info any?
  ...
  ([namespace string?, body v1/pod-template, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-pod-template v1/pod-template-spec
  "
  create a PodTemplate"
  ...
  ([namespace string?, body v1/pod-template, optional-params any?]
   (let [res (:data (create-namespaced-pod-template-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/pod-template-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-replication-controller-with-http-info any?
  ...
  ([namespace string?, body v1/replication-controller, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-replication-controller v1/replication-controller-spec
  "
  create a ReplicationController"
  ...
  ([namespace string?, body v1/replication-controller, optional-params any?]
   (let [res (:data (create-namespaced-replication-controller-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/replication-controller-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-resource-quota-with-http-info any?
  ...
  ([namespace string?, body v1/resource-quota, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-resource-quota v1/resource-quota-spec
  "
  create a ResourceQuota"
  ...
  ([namespace string?, body v1/resource-quota, optional-params any?]
   (let [res (:data (create-namespaced-resource-quota-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/resource-quota-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-secret-with-http-info any?
  ...
  ([namespace string?, body v1/secret, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-secret v1/secret-spec
  "
  create a Secret"
  ...
  ([namespace string?, body v1/secret, optional-params any?]
   (let [res (:data (create-namespaced-secret-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/secret-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-service-with-http-info any?
  ...
  ([namespace string?, body v1/service, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-service v1/service-spec
  "
  create a Service"
  ...
  ([namespace string?, body v1/service, optional-params any?]
   (let [res (:data (create-namespaced-service-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/service-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-service-account-with-http-info any?
  ...
  ([namespace string?, body v1/service-account, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-service-account v1/service-account-spec
  "
  create a ServiceAccount"
  ...
  ([namespace string?, body v1/service-account, optional-params any?]
   (let [res (:data (create-namespaced-service-account-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/service-account-spec res st/string-transformer)
        res))))
...
(defn-spec create-node-with-http-info any?
  ...
  ([body v1/node, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
...
(defn-spec create-node v1/node-spec
  "
  create a Node"
  ...
  ([body v1/node, optional-params any?]
   (let [res (:data (create-node-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/node-spec res st/string-transformer)
        res))))
...
(defn-spec create-persistent-volume-with-http-info any?
  ...
  ([body v1/persistent-volume, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
...
(defn-spec create-persistent-volume v1/persistent-volume-spec
  "
  create a PersistentVolume"
  ...
  ([body v1/persistent-volume, optional-params any?]
   (let [res (:data (create-persistent-volume-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/persistent-volume-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-config-map v1/status-spec
  "
  delete collection of ConfigMap"
...
(defn-spec delete-collection-namespaced-endpoints v1/status-spec
  "
  delete collection of Endpoints"
...
(defn-spec delete-collection-namespaced-event v1/status-spec
  "
  delete collection of Event"
...
(defn-spec delete-collection-namespaced-limit-range v1/status-spec
  "
  delete collection of LimitRange"
...
(defn-spec delete-collection-namespaced-persistent-volume-claim v1/status-spec
  "
  delete collection of PersistentVolumeClaim"
...
(defn-spec delete-collection-namespaced-pod v1/status-spec
  "
  delete collection of Pod"
...
(defn-spec delete-collection-namespaced-pod-template v1/status-spec
  "
  delete collection of PodTemplate"
...
(defn-spec delete-collection-namespaced-replication-controller v1/status-spec
  "
  delete collection of ReplicationController"
...
(defn-spec delete-collection-namespaced-resource-quota v1/status-spec
  "
  delete collection of ResourceQuota"
...
(defn-spec delete-collection-namespaced-secret v1/status-spec
  "
  delete collection of Secret"
...
(defn-spec delete-collection-namespaced-service-account v1/status-spec
  "
  delete collection of ServiceAccount"
...
(defn-spec delete-collection-node v1/status-spec
  "
  delete collection of Node"
...
(defn-spec delete-collection-persistent-volume v1/status-spec
  "
  delete collection of PersistentVolume"
...
(defn-spec delete-namespace-with-http-info any?
  "
  delete a Namespace"
  ([name string?, body v1/delete-options, ] (delete-namespace-with-http-info name body nil))
...
(defn-spec delete-namespace v1/status-spec
  "
  delete a Namespace"
  ([name string?, body v1/delete-options, ] (delete-namespace name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespace-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-config-map-with-http-info any?
  "
  delete a ConfigMap"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-config-map-with-http-info name namespace body nil))
...
(defn-spec delete-namespaced-config-map v1/status-spec
  "
  delete a ConfigMap"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-config-map name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-config-map-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-endpoints-with-http-info any?
  "
  delete Endpoints"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-endpoints-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-endpoints v1/status-spec
  "
  delete Endpoints"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-endpoints name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-endpoints-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-event-with-http-info any?
  "
  delete an Event"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-event-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-event v1/status-spec
  "
  delete an Event"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-event name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-event-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-limit-range-with-http-info any?
  "
  delete a LimitRange"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-limit-range-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-limit-range v1/status-spec
  "
  delete a LimitRange"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-limit-range name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-limit-range-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-persistent-volume-claim-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-persistent-volume-claim-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-persistent-volume-claim v1/status-spec
  "
  delete a PersistentVolumeClaim"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-persistent-volume-claim name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-persistent-volume-claim-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-pod-with-http-info any?
  "
  delete a Pod"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-pod v1/status-spec
  "
  delete a Pod"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-pod-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-pod-template-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-template-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-pod-template v1/status-spec
  "
  delete a PodTemplate"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-template name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-pod-template-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-replication-controller-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-replication-controller-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-replication-controller v1/status-spec
  "
  delete a ReplicationController"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-replication-controller name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-replication-controller-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-resource-quota-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-resource-quota-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-resource-quota v1/status-spec
  "
  delete a ResourceQuota"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-resource-quota name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-resource-quota-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-secret-with-http-info any?
  "
  delete a Secret"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-secret-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-secret v1/status-spec
  "
  delete a Secret"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-secret name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-secret-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-service v1/status-spec
  "
  delete a Service"
...
(defn-spec delete-namespaced-service-account-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-service-account-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-service-account v1/status-spec
  "
  delete a ServiceAccount"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-service-account name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-service-account-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-node-with-http-info any?
  "
  delete a Node"
  ([name string?, body v1/delete-options, ] (delete-node-with-http-info name body nil))
  ([name string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec delete-node v1/status-spec
  "
  delete a Node"
  ([name string?, body v1/delete-options, ] (delete-node name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-node-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-persistent-volume-with-http-info any?
  ...
  ([name string?, body v1/delete-options, ] (delete-persistent-volume-with-http-info name body nil))
  ([name string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec delete-persistent-volume v1/status-spec
  "
  delete a PersistentVolume"
  ([name string?, body v1/delete-options, ] (delete-persistent-volume name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-persistent-volume-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec list-component-status v1/component-status-list-spec
  "
  list objects of kind ComponentStatus"
  ...
  ([optional-params any?]
   (let [res (:data (list-component-status-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/component-status-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-config-map-for-all-namespaces v1/config-map-list-spec
  "
  list or watch objects of kind ConfigMap"
  ...
  ([optional-params any?]
   (let [res (:data (list-config-map-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/config-map-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-endpoints-for-all-namespaces v1/endpoints-list-spec
  "
  list or watch objects of kind Endpoints"
  ...
  ([optional-params any?]
   (let [res (:data (list-endpoints-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/endpoints-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-event-for-all-namespaces v1/event-list-spec
  "
  list or watch objects of kind Event"
  ...
  ([optional-params any?]
   (let [res (:data (list-event-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/event-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-limit-range-for-all-namespaces v1/limit-range-list-spec
  "
  list or watch objects of kind LimitRange"
  ...
  ([optional-params any?]
   (let [res (:data (list-limit-range-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/limit-range-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespace v1/namespace-list-spec
  "
  list or watch objects of kind Namespace"
  ([] (list-namespace nil))
  ([optional-params any?]
   (let [res (:data (list-namespace-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/namespace-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-config-map v1/config-map-list-spec
  "
  list or watch objects of kind ConfigMap"
...
(defn-spec list-namespaced-endpoints v1/endpoints-list-spec
  "
  list or watch objects of kind Endpoints"
...
(defn-spec list-namespaced-event v1/event-list-spec
  "
  list or watch objects of kind Event"
...
(defn-spec list-namespaced-limit-range v1/limit-range-list-spec
  "
  list or watch objects of kind LimitRange"
...
(defn-spec list-namespaced-persistent-volume-claim v1/persistent-volume-claim-list-spec
  "
  list or watch objects of kind PersistentVolumeClaim"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-persistent-volume-claim-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/persistent-volume-claim-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-pod v1/pod-list-spec
  "
  list or watch objects of kind Pod"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-pod-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/pod-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-pod-template v1/pod-template-list-spec
  "
  list or watch objects of kind PodTemplate"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-pod-template-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/pod-template-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-replication-controller v1/replication-controller-list-spec
  "
  list or watch objects of kind ReplicationController"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-replication-controller-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/replication-controller-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-resource-quota v1/resource-quota-list-spec
  "
  list or watch objects of kind ResourceQuota"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-resource-quota-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/resource-quota-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-secret v1/secret-list-spec
  "
  list or watch objects of kind Secret"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-secret-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/secret-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-service v1/service-list-spec
  "
  list or watch objects of kind Service"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-service-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/service-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-service-account v1/service-account-list-spec
  "
  list or watch objects of kind ServiceAccount"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-service-account-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/service-account-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-node v1/node-list-spec
  "
  list or watch objects of kind Node"
  ([] (list-node nil))
  ([optional-params any?]
   (let [res (:data (list-node-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/node-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-persistent-volume v1/persistent-volume-list-spec
  "
  list or watch objects of kind PersistentVolume"
  ...
  ([optional-params any?]
   (let [res (:data (list-persistent-volume-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/persistent-volume-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-persistent-volume-claim-for-all-namespaces v1/persistent-volume-claim-list-spec
  "
  list or watch objects of kind PersistentVolumeClaim"
...
(defn-spec list-pod-for-all-namespaces v1/pod-list-spec
  "
  list or watch objects of kind Pod"
...
(defn-spec list-pod-template-for-all-namespaces v1/pod-template-list-spec
  "
  list or watch objects of kind PodTemplate"
...
(defn-spec list-replication-controller-for-all-namespaces v1/replication-controller-list-spec
  "
  list or watch objects of kind ReplicationController"
...
(defn-spec list-resource-quota-for-all-namespaces v1/resource-quota-list-spec
  "
  list or watch objects of kind ResourceQuota"
...
(defn-spec list-secret-for-all-namespaces v1/secret-list-spec
  "
  list or watch objects of kind Secret"
...
(defn-spec list-service-account-for-all-namespaces v1/service-account-list-spec
  "
  list or watch objects of kind ServiceAccount"
...
(defn-spec list-service-for-all-namespaces v1/service-list-spec
  "
  list or watch objects of kind Service"
...
(defn-spec patch-namespace v1/namespace-spec
  "
  partially update the specified Namespace"
...
(defn-spec patch-namespace-status v1/namespace-spec
  "
  partially update status of the specified Namespace"
...
(defn-spec patch-namespaced-config-map v1/config-map-spec
  "
  partially update the specified ConfigMap"
...
(defn-spec patch-namespaced-endpoints v1/endpoints-spec
  "
  partially update the specified Endpoints"
...
(defn-spec patch-namespaced-event v1/event-spec
  "
  partially update the specified Event"
...
(defn-spec patch-namespaced-limit-range v1/limit-range-spec
  "
  partially update the specified LimitRange"
...
(defn-spec patch-namespaced-persistent-volume-claim v1/persistent-volume-claim-spec
  "
  partially update the specified PersistentVolumeClaim"
...
(defn-spec patch-namespaced-persistent-volume-claim-status v1/persistent-volume-claim-spec
  "
  partially update status of the specified PersistentVolumeClaim"
...
(defn-spec patch-namespaced-pod v1/pod-spec
  "
  partially update the specified Pod"
...
(defn-spec patch-namespaced-pod-status v1/pod-spec
  "
  partially update status of the specified Pod"
...
(defn-spec patch-namespaced-pod-template v1/pod-template-spec
  "
  partially update the specified PodTemplate"
...
(defn-spec patch-namespaced-replication-controller v1/replication-controller-spec
  "
  partially update the specified ReplicationController"
...
(defn-spec patch-namespaced-replication-controller-scale v1/scale-spec
  "
  partially update scale of the specified ReplicationController"
  ...
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-replication-controller-scale-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/scale-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-replication-controller-status v1/replication-controller-spec
  "
  partially update status of the specified ReplicationController"
...
(defn-spec patch-namespaced-resource-quota v1/resource-quota-spec
  "
  partially update the specified ResourceQuota"
...
(defn-spec patch-namespaced-resource-quota-status v1/resource-quota-spec
  "
  partially update status of the specified ResourceQuota"
...
(defn-spec patch-namespaced-secret v1/secret-spec
  "
  partially update the specified Secret"
...
(defn-spec patch-namespaced-service v1/service-spec
  "
  partially update the specified Service"
...
(defn-spec patch-namespaced-service-account v1/service-account-spec
  "
  partially update the specified ServiceAccount"
...
(defn-spec patch-namespaced-service-status v1/service-spec
  "
  partially update status of the specified Service"
...
(defn-spec patch-node v1/node-spec
  "
  partially update the specified Node"
...
(defn-spec patch-node-status v1/node-spec
  "
  partially update status of the specified Node"
...
(defn-spec patch-persistent-volume v1/persistent-volume-spec
  "
  partially update the specified PersistentVolume"
...
(defn-spec patch-persistent-volume-status v1/persistent-volume-spec
  "
  partially update status of the specified PersistentVolume"
...
(defn-spec proxy-delete-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-delete-namespaced-pod string?
  "
  proxy DELETE requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-delete-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-delete-namespaced-pod-with-path-with-http-info any?
  "
  proxy DELETE requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-delete-namespaced-pod-with-path string?
  "
  proxy DELETE requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-delete-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-delete-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-delete-namespaced-service string?
  "
  proxy DELETE requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-delete-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-delete-namespaced-service-with-path-with-http-info any?
  "
  proxy DELETE requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-delete-namespaced-service-with-path string?
  "
  proxy DELETE requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-delete-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-delete-node-with-http-info any?
  "
...
(defn-spec proxy-delete-node string?
  "
  proxy DELETE requests to Node"
  [name string?]
  (let [res (:data (proxy-delete-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-delete-node-with-path-with-http-info any?
  "
  proxy DELETE requests to Node"
...
(defn-spec proxy-delete-node-with-path string?
  "
  proxy DELETE requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-delete-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-get-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-get-namespaced-pod string?
  "
  proxy GET requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-get-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-get-namespaced-pod-with-path-with-http-info any?
  "
  proxy GET requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-get-namespaced-pod-with-path string?
  "
  proxy GET requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-get-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-get-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-get-namespaced-service string?
  "
  proxy GET requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-get-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-get-namespaced-service-with-path-with-http-info any?
  "
  proxy GET requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-get-namespaced-service-with-path string?
  "
  proxy GET requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-get-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-get-node-with-http-info any?
  "
...
(defn-spec proxy-get-node string?
  "
  proxy GET requests to Node"
  [name string?]
  (let [res (:data (proxy-get-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-get-node-with-path-with-http-info any?
  "
  proxy GET requests to Node"
  [name string?, path string?]
  (check-required-params name path)
...
(defn-spec proxy-get-node-with-path string?
  "
  proxy GET requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-get-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-head-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-head-namespaced-pod string?
  "
  proxy HEAD requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-head-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-head-namespaced-pod-with-path-with-http-info any?
  "
  proxy HEAD requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-head-namespaced-pod-with-path string?
  "
  proxy HEAD requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-head-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-head-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-head-namespaced-service string?
  "
  proxy HEAD requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-head-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-head-namespaced-service-with-path-with-http-info any?
  "
  proxy HEAD requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-head-namespaced-service-with-path string?
  "
  proxy HEAD requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-head-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-head-node-with-http-info any?
  "
...
(defn-spec proxy-head-node string?
  "
  proxy HEAD requests to Node"
  [name string?]
  (let [res (:data (proxy-head-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-head-node-with-path-with-http-info any?
  "
  proxy HEAD requests to Node"
  [name string?, path string?]
  (check-required-params name path)
...
(defn-spec proxy-head-node-with-path string?
  "
  proxy HEAD requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-head-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-options-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-options-namespaced-pod string?
  "
  proxy OPTIONS requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-options-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-options-namespaced-pod-with-path-with-http-info any?
  "
  proxy OPTIONS requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-options-namespaced-pod-with-path string?
  "
  proxy OPTIONS requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-options-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-options-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-options-namespaced-service string?
  "
  proxy OPTIONS requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-options-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-options-namespaced-service-with-path-with-http-info any?
  "
  proxy OPTIONS requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-options-namespaced-service-with-path string?
  "
  proxy OPTIONS requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-options-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-options-node-with-http-info any?
  "
...
(defn-spec proxy-options-node string?
  "
  proxy OPTIONS requests to Node"
  [name string?]
  (let [res (:data (proxy-options-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-options-node-with-path-with-http-info any?
  "
  proxy OPTIONS requests to Node"
  [name string?, path string?]
  (check-required-params name path)
...
(defn-spec proxy-options-node-with-path string?
  "
  proxy OPTIONS requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-options-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-patch-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-patch-namespaced-pod string?
  "
  proxy PATCH requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-patch-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-patch-namespaced-pod-with-path-with-http-info any?
  "
  proxy PATCH requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-patch-namespaced-pod-with-path string?
  "
  proxy PATCH requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-patch-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-patch-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-patch-namespaced-service string?
  "
  proxy PATCH requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-patch-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-patch-namespaced-service-with-path-with-http-info any?
  "
  proxy PATCH requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-patch-namespaced-service-with-path string?
  "
  proxy PATCH requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-patch-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-patch-node-with-http-info any?
  "
...
(defn-spec proxy-patch-node string?
  "
  proxy PATCH requests to Node"
  [name string?]
  (let [res (:data (proxy-patch-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-patch-node-with-path-with-http-info any?
  "
  proxy PATCH requests to Node"
  [name string?, path string?]
  (check-required-params name path)
...
(defn-spec proxy-patch-node-with-path string?
  "
  proxy PATCH requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-patch-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-post-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-post-namespaced-pod string?
  "
  proxy POST requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-post-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-post-namespaced-pod-with-path-with-http-info any?
  "
  proxy POST requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-post-namespaced-pod-with-path string?
  "
  proxy POST requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-post-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-post-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-post-namespaced-service string?
  "
  proxy POST requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-post-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-post-namespaced-service-with-path-with-http-info any?
  "
  proxy POST requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-post-namespaced-service-with-path string?
  "
  proxy POST requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-post-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-post-node-with-http-info any?
  "
...
(defn-spec proxy-post-node string?
  "
  proxy POST requests to Node"
  [name string?]
  (let [res (:data (proxy-post-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-post-node-with-path-with-http-info any?
  "
  proxy POST requests to Node"
  [name string?, path string?]
  (check-required-params name path)
...
(defn-spec proxy-post-node-with-path string?
  "
  proxy POST requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-post-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-put-namespaced-pod-with-http-info any?
  "
...
(defn-spec proxy-put-namespaced-pod string?
  "
  proxy PUT requests to Pod"
  [name string?, namespace string?]
  (let [res (:data (proxy-put-namespaced-pod-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-put-namespaced-pod-with-path-with-http-info any?
  "
  proxy PUT requests to Pod"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-put-namespaced-pod-with-path string?
  "
  proxy PUT requests to Pod"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-put-namespaced-pod-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-put-namespaced-service-with-http-info any?
  "
...
(defn-spec proxy-put-namespaced-service string?
  "
  proxy PUT requests to Service"
  [name string?, namespace string?]
  (let [res (:data (proxy-put-namespaced-service-with-http-info name namespace))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-put-namespaced-service-with-path-with-http-info any?
  "
  proxy PUT requests to Service"
  [name string?, namespace string?, path string?]
  (check-required-params name namespace path)
...
(defn-spec proxy-put-namespaced-service-with-path string?
  "
  proxy PUT requests to Service"
  [name string?, namespace string?, path string?]
  (let [res (:data (proxy-put-namespaced-service-with-path-with-http-info name namespace path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-put-node-with-http-info any?
  "
...
(defn-spec proxy-put-node string?
  "
  proxy PUT requests to Node"
  [name string?]
  (let [res (:data (proxy-put-node-with-http-info name))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))


(defn-spec proxy-put-node-with-path-with-http-info any?
  "
  proxy PUT requests to Node"
  [name string?, path string?]
  (check-required-params name path)
...
(defn-spec proxy-put-node-with-path string?
  "
  proxy PUT requests to Node"
  [name string?, path string?]
  (let [res (:data (proxy-put-node-with-path-with-http-info name path))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
...
(defn-spec read-component-status v1/component-status-spec
  "
  read the specified ComponentStatus"
  ...
  ([name string?, optional-params any?]
   (let [res (:data (read-component-status-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/component-status-spec res st/string-transformer)
        res))))
...
(defn-spec read-namespace v1/namespace-spec
  "
  read the specified Namespace"
...
(defn-spec read-namespace-status v1/namespace-spec
  "
  read status of the specified Namespace"
...
(defn-spec read-namespaced-config-map v1/config-map-spec
  "
  read the specified ConfigMap"
...
(defn-spec read-namespaced-endpoints v1/endpoints-spec
  "
  read the specified Endpoints"
...
(defn-spec read-namespaced-event v1/event-spec
  "
  read the specified Event"
...
(defn-spec read-namespaced-limit-range v1/limit-range-spec
  "
  read the specified LimitRange"
...
(defn-spec read-namespaced-persistent-volume-claim v1/persistent-volume-claim-spec
  "
  read the specified PersistentVolumeClaim"
...
(defn-spec read-namespaced-persistent-volume-claim-status v1/persistent-volume-claim-spec
  "
  read status of the specified PersistentVolumeClaim"
...
(defn-spec read-namespaced-pod v1/pod-spec
  "
  read the specified Pod"
...
(defn-spec read-namespaced-pod-log-with-http-info any?
  ...
  ([name string?, namespace string?, {:keys [container follow limitBytes pretty previous sinceSeconds tailLines timestamps]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
   (call-api "/api/v1/namespaces/{namespace}/pods/{name}/log" :get
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"container" container "follow" follow "limitBytes" limitBytes "pretty" pretty "previous" previous "sinceSeconds" sinceSeconds "tailLines" tailLines "timestamps" timestamps }
              :form-params   {}
              :content-types []
...
(defn-spec read-namespaced-pod-status v1/pod-spec
  "
  read status of the specified Pod"
...
(defn-spec read-namespaced-pod-template v1/pod-template-spec
  "
  read the specified PodTemplate"
...
(defn-spec read-namespaced-replication-controller v1/replication-controller-spec
  "
  read the specified ReplicationController"
...
(defn-spec read-namespaced-replication-controller-scale v1/scale-spec
  "
  read scale of the specified ReplicationController"
...
(defn-spec read-namespaced-replication-controller-status v1/replication-controller-spec
  "
  read status of the specified ReplicationController"
...
(defn-spec read-namespaced-resource-quota v1/resource-quota-spec
  "
  read the specified ResourceQuota"
...
(defn-spec read-namespaced-resource-quota-status v1/resource-quota-spec
  "
  read status of the specified ResourceQuota"
...
(defn-spec read-namespaced-secret v1/secret-spec
  "
  read the specified Secret"
...
(defn-spec read-namespaced-service v1/service-spec
  "
  read the specified Service"
...
(defn-spec read-namespaced-service-account v1/service-account-spec
  "
  read the specified ServiceAccount"
...
(defn-spec read-namespaced-service-status v1/service-spec
  "
  read status of the specified Service"
...
(defn-spec read-node v1/node-spec
  "
  read the specified Node"
...
(defn-spec read-node-status v1/node-spec
  "
  read status of the specified Node"
...
(defn-spec read-persistent-volume v1/persistent-volume-spec
  "
  read the specified PersistentVolume"
...
(defn-spec read-persistent-volume-status v1/persistent-volume-spec
  "
  read status of the specified PersistentVolume"
...
(defn-spec replace-namespace-with-http-info any?
  ...
  ([name string?, body v1/namespace, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-namespace v1/namespace-spec
  "
  replace the specified Namespace"
...
(defn-spec replace-namespace-finalize v1/namespace-spec
  "
  replace finalize of the specified Namespace"
...
(defn-spec replace-namespace-status v1/namespace-spec
  "
  replace status of the specified Namespace"
...
(defn-spec replace-namespaced-config-map-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/config-map, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-config-map v1/config-map-spec
  "
  replace the specified ConfigMap"
...
(defn-spec replace-namespaced-endpoints-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/endpoints, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-endpoints v1/endpoints-spec
  "
  replace the specified Endpoints"
...
(defn-spec replace-namespaced-event-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/event, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-event v1/event-spec
  "
  replace the specified Event"
...
(defn-spec replace-namespaced-limit-range-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/limit-range, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-limit-range v1/limit-range-spec
  "
  replace the specified LimitRange"
...
(defn-spec replace-namespaced-persistent-volume-claim-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/persistent-volume-claim, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-persistent-volume-claim v1/persistent-volume-claim-spec
  "
  replace the specified PersistentVolumeClaim"
...
(defn-spec replace-namespaced-persistent-volume-claim-status v1/persistent-volume-claim-spec
  "
  replace status of the specified PersistentVolumeClaim"
...
(defn-spec replace-namespaced-pod-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/pod, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-pod v1/pod-spec
  "
  replace the specified Pod"
...
(defn-spec replace-namespaced-pod-status v1/pod-spec
  "
  replace status of the specified Pod"
...
(defn-spec replace-namespaced-pod-template-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/pod-template, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-pod-template v1/pod-template-spec
  "
  replace the specified PodTemplate"
...
(defn-spec replace-namespaced-replication-controller-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/replication-controller, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-replication-controller v1/replication-controller-spec
  "
  replace the specified ReplicationController"
...
(defn-spec replace-namespaced-replication-controller-scale-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/scale, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-replication-controller-scale v1/scale-spec
  "
  replace scale of the specified ReplicationController"
...
(defn-spec replace-namespaced-replication-controller-status v1/replication-controller-spec
  "
  replace status of the specified ReplicationController"
...
(defn-spec replace-namespaced-resource-quota-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/resource-quota, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-resource-quota v1/resource-quota-spec
  "
  replace the specified ResourceQuota"
...
(defn-spec replace-namespaced-resource-quota-status v1/resource-quota-spec
  "
  replace status of the specified ResourceQuota"
...
(defn-spec replace-namespaced-secret-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/secret, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-secret v1/secret-spec
  "
  replace the specified Secret"
...
(defn-spec replace-namespaced-service-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/service, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-service v1/service-spec
  "
  replace the specified Service"
...
(defn-spec replace-namespaced-service-account-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/service-account, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-service-account v1/service-account-spec
  "
  replace the specified ServiceAccount"
...
(defn-spec replace-namespaced-service-status v1/service-spec
  "
  replace status of the specified Service"
...
(defn-spec replace-node-with-http-info any?
  ...
  ([name string?, body v1/node, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-node v1/node-spec
  "
  replace the specified Node"
...
(defn-spec replace-node-status v1/node-spec
  "
  replace status of the specified Node"
...
(defn-spec replace-persistent-volume-with-http-info any?
  ...
  ([name string?, body v1/persistent-volume, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-persistent-volume v1/persistent-volume-spec
  "
  replace the specified PersistentVolume"
...
(defn-spec replace-persistent-volume-status v1/persistent-volume-spec
  "
  replace status of the specified PersistentVolume"
