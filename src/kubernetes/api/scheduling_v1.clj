(ns kubernetes.api.scheduling-v1
...
(defn-spec create-priority-class-with-http-info any?
  ...
  ([body v1/priority-class, ] (create-priority-class-with-http-info body nil))
  ([body v1/priority-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-priority-class v1/priority-class-spec
  "
  create a PriorityClass"
  ([body v1/priority-class, ] (create-priority-class body nil))
  ([body v1/priority-class, optional-params any?]
   (let [res (:data (create-priority-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/priority-class-spec res st/string-transformer)
        res))))
...
(defn-spec list-priority-class v1/priority-class-list-spec
  "
  list or watch objects of kind PriorityClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-priority-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/priority-class-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-priority-class v1/priority-class-spec
  "
  partially update the specified PriorityClass"
...
(defn-spec read-priority-class v1/priority-class-spec
  "
  read the specified PriorityClass"
...
(defn-spec replace-priority-class-with-http-info any?
  ...
  ([name string?, body v1/priority-class, ] (replace-priority-class-with-http-info name body nil))
  ([name string?, body v1/priority-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-priority-class v1/priority-class-spec
  "
  replace the specified PriorityClass"
  ([name string?, body v1/priority-class, ] (replace-priority-class name body nil))
  ([name string?, body v1/priority-class, optional-params any?]
