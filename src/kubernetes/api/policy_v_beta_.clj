...
(defn-spec create-namespaced-pod-disruption-budget-with-http-info any?
  ...
  ([namespace string?, body v1beta1/pod-disruption-budget, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec delete-namespaced-pod-disruption-budget-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-disruption-budget-with-http-info name namespace body nil))
...
(defn-spec delete-namespaced-pod-disruption-budget v1/status-spec
  "
  delete a PodDisruptionBudget"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-disruption-budget name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-pod-disruption-budget-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-pod-disruption-budget-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/pod-disruption-budget, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
