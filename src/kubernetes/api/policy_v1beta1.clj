...
(defn-spec create-namespaced-pod-disruption-budget v1beta1/pod-disruption-budget-spec
  "
  create a PodDisruptionBudget"
  ...
  ([namespace string?, body v1beta1/pod-disruption-budget, optional-params any?]
   (let [res (:data (create-namespaced-pod-disruption-budget-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/pod-disruption-budget-spec res st/string-transformer)
        res))))
...
(defn-spec create-pod-security-policy policy/v1beta1/pod-security-policy-spec
  "
  create a PodSecurityPolicy"
  ...
  ([body policy/v1beta1/pod-security-policy, optional-params any?]
   (let [res (:data (create-pod-security-policy-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode policy/v1beta1/pod-security-policy-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-pod-disruption-budget v1/status-spec
  "
  delete collection of PodDisruptionBudget"
...
(defn-spec delete-namespaced-pod-disruption-budget v1/status-spec
  "
  delete a PodDisruptionBudget"
...
(defn-spec list-namespaced-pod-disruption-budget v1beta1/pod-disruption-budget-list-spec
  "
  list or watch objects of kind PodDisruptionBudget"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-pod-disruption-budget-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/pod-disruption-budget-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-pod-disruption-budget-for-all-namespaces v1beta1/pod-disruption-budget-list-spec
  "
  list or watch objects of kind PodDisruptionBudget"
...
(defn-spec list-pod-security-policy policy/v1beta1/pod-security-policy-list-spec
  "
  list or watch objects of kind PodSecurityPolicy"
  ...
  ([optional-params any?]
   (let [res (:data (list-pod-security-policy-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode policy/v1beta1/pod-security-policy-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-pod-disruption-budget v1beta1/pod-disruption-budget-spec
  "
  partially update the specified PodDisruptionBudget"
...
(defn-spec patch-namespaced-pod-disruption-budget-status v1beta1/pod-disruption-budget-spec
  "
  partially update status of the specified PodDisruptionBudget"
...
(defn-spec patch-pod-security-policy policy/v1beta1/pod-security-policy-spec
  "
  partially update the specified PodSecurityPolicy"
...
(defn-spec read-namespaced-pod-disruption-budget v1beta1/pod-disruption-budget-spec
  "
  read the specified PodDisruptionBudget"
...
(defn-spec read-namespaced-pod-disruption-budget-status v1beta1/pod-disruption-budget-spec
  "
  read status of the specified PodDisruptionBudget"
...
(defn-spec read-pod-security-policy policy/v1beta1/pod-security-policy-spec
  "
  read the specified PodSecurityPolicy"
...
(defn-spec replace-namespaced-pod-disruption-budget v1beta1/pod-disruption-budget-spec
  "
  replace the specified PodDisruptionBudget"
...
(defn-spec replace-namespaced-pod-disruption-budget-status v1beta1/pod-disruption-budget-spec
  "
  replace status of the specified PodDisruptionBudget"
...
(defn-spec replace-pod-security-policy policy/v1beta1/pod-security-policy-spec
  "
  replace the specified PodSecurityPolicy"
