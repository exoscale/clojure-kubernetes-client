(ns kubernetes.api.authorization-v-
...
(defn-spec create-namespaced-local-subject-access-review-with-http-info any?
  ...
  ([namespace string?, body v1/local-subject-access-review, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-local-subject-access-review v1/local-subject-access-review-spec
  "
  create a LocalSubjectAccessReview"
  ...
  ([namespace string?, body v1/local-subject-access-review, optional-params any?]
   (let [res (:data (create-namespaced-local-subject-access-review-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/local-subject-access-review-spec res st/string-transformer)
        res))))
...
(defn-spec create-self-subject-access-review-with-http-info any?
  ...
  ([body v1/self-subject-access-review, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-self-subject-access-review v1/self-subject-access-review-spec
  "
  create a SelfSubjectAccessReview"
  ...
  ([body v1/self-subject-access-review, optional-params any?]
   (let [res (:data (create-self-subject-access-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/self-subject-access-review-spec res st/string-transformer)
        res))))
...
(defn-spec create-self-subject-rules-review-with-http-info any?
  ...
  ([body v1/self-subject-rules-review, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
...
(defn-spec create-self-subject-rules-review v1/self-subject-rules-review-spec
  "
  create a SelfSubjectRulesReview"
  ...
  ([body v1/self-subject-rules-review, optional-params any?]
   (let [res (:data (create-self-subject-rules-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/self-subject-rules-review-spec res st/string-transformer)
        res))))
...
(defn-spec create-subject-access-review-with-http-info any?
  ...
  ([body v1/subject-access-review, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
...
(defn-spec create-subject-access-review v1/subject-access-review-spec
  "
  create a SubjectAccessReview"
  ...
  ([body v1/subject-access-review, optional-params any?]
   (let [res (:data (create-subject-access-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/subject-access-review-spec res st/string-transformer)
        res))))
