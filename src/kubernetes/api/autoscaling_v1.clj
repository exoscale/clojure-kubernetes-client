(ns kubernetes.api.autoscaling-v1
...
(defn-spec create-namespaced-horizontal-pod-autoscaler-with-http-info any?
  ...
  ([namespace string?, body v1/horizontal-pod-autoscaler, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec replace-namespaced-horizontal-pod-autoscaler-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/horizontal-pod-autoscaler, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
