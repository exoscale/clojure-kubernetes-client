(ns kubernetes.api.apiextensions-v1beta1
...
(defn-spec patch-custom-resource-definition-status v1beta1/custom-resource-definition-spec
  "
  partially update status of the specified CustomResourceDefinition"
...
(defn-spec read-custom-resource-definition-status v1beta1/custom-resource-definition-spec
  "
  read status of the specified CustomResourceDefinition"
