...
(defn-spec create-namespaced-ingress extensions/v1beta1/ingress-spec
  "
  create an Ingress"
  ...
  ([namespace string?, body extensions/v1beta1/ingress, optional-params any?]
   (let [res (:data (create-namespaced-ingress-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode extensions/v1beta1/ingress-spec res st/string-transformer)
        res))))
...
(defn-spec create-pod-security-policy extensions/v1beta1/pod-security-policy-spec
  "
  create a PodSecurityPolicy"
  ...
  ([body extensions/v1beta1/pod-security-policy, optional-params any?]
   (let [res (:data (create-pod-security-policy-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode extensions/v1beta1/pod-security-policy-spec res st/string-transformer)
        res))))
...
(defn-spec list-ingress-for-all-namespaces extensions/v1beta1/ingress-list-spec
  "
  list or watch objects of kind Ingress"
  ...
  ([optional-params any?]
   (let [res (:data (list-ingress-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode extensions/v1beta1/ingress-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-ingress extensions/v1beta1/ingress-list-spec
  "
  list or watch objects of kind Ingress"
...
(defn-spec list-pod-security-policy extensions/v1beta1/pod-security-policy-list-spec
  "
  list or watch objects of kind PodSecurityPolicy"
  ...
  ([optional-params any?]
   (let [res (:data (list-pod-security-policy-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode extensions/v1beta1/pod-security-policy-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-ingress extensions/v1beta1/ingress-spec
  "
  partially update the specified Ingress"
...
(defn-spec patch-namespaced-ingress-status extensions/v1beta1/ingress-spec
  "
  partially update status of the specified Ingress"
...
(defn-spec patch-pod-security-policy extensions/v1beta1/pod-security-policy-spec
  "
  partially update the specified PodSecurityPolicy"
...
(defn-spec read-namespaced-ingress extensions/v1beta1/ingress-spec
  "
  read the specified Ingress"
...
(defn-spec read-namespaced-ingress-status extensions/v1beta1/ingress-spec
  "
  read status of the specified Ingress"
...
(defn-spec read-pod-security-policy extensions/v1beta1/pod-security-policy-spec
  "
  read the specified PodSecurityPolicy"
...
(defn-spec replace-namespaced-ingress extensions/v1beta1/ingress-spec
  "
  replace the specified Ingress"
...
(defn-spec replace-namespaced-ingress-status extensions/v1beta1/ingress-spec
  "
  replace status of the specified Ingress"
...
(defn-spec replace-pod-security-policy extensions/v1beta1/pod-security-policy-spec
  "
  replace the specified PodSecurityPolicy"
