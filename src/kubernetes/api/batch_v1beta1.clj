...
(defn-spec create-namespaced-cron-job-with-http-info any?
  ...
  ([namespace string?, body v1beta1/cron-job, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec replace-namespaced-cron-job-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/cron-job, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
