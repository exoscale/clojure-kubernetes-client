(ns kubernetes.api.rbac-authorization-v1alpha1
...
(defn-spec create-cluster-role-with-http-info any?
  ...
  ([body v1alpha1/cluster-role, ] (create-cluster-role-with-http-info body nil))
  ([body v1alpha1/cluster-role, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec create-cluster-role v1alpha1/cluster-role-spec
  "
  create a ClusterRole"
  ([body v1alpha1/cluster-role, ] (create-cluster-role body nil))
  ([body v1alpha1/cluster-role, optional-params any?]
   (let [res (:data (create-cluster-role-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/cluster-role-spec res st/string-transformer)
        res))))
...
(defn-spec create-cluster-role-binding-with-http-info any?
  ...
  ([body v1alpha1/cluster-role-binding, ] (create-cluster-role-binding-with-http-info body nil))
  ([body v1alpha1/cluster-role-binding, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec create-cluster-role-binding v1alpha1/cluster-role-binding-spec
  "
  create a ClusterRoleBinding"
  ([body v1alpha1/cluster-role-binding, ] (create-cluster-role-binding body nil))
  ([body v1alpha1/cluster-role-binding, optional-params any?]
   (let [res (:data (create-cluster-role-binding-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/cluster-role-binding-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-role-with-http-info any?
  "
  create a Role"
  ([namespace string?, body v1alpha1/role, ] (create-namespaced-role-with-http-info namespace body nil))
  ([namespace string?, body v1alpha1/role, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles" :post
...
(defn-spec create-namespaced-role v1alpha1/role-spec
  "
  create a Role"
  ([namespace string?, body v1alpha1/role, ] (create-namespaced-role namespace body nil))
  ([namespace string?, body v1alpha1/role, optional-params any?]
   (let [res (:data (create-namespaced-role-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/role-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-role-binding-with-http-info any?
  ...
  ([namespace string?, body v1alpha1/role-binding, ] (create-namespaced-role-binding-with-http-info namespace body nil))
  ([namespace string?, body v1alpha1/role-binding, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings" :post
             {:path-params   {"namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec create-namespaced-role-binding v1alpha1/role-binding-spec
  "
  create a RoleBinding"
  ([namespace string?, body v1alpha1/role-binding, ] (create-namespaced-role-binding namespace body nil))
  ([namespace string?, body v1alpha1/role-binding, optional-params any?]
   (let [res (:data (create-namespaced-role-binding-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/role-binding-spec res st/string-transformer)
        res))))
...
(defn-spec delete-cluster-role-with-http-info any?
  ...
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}" :delete
...
(defn-spec delete-cluster-role-binding-with-http-info any?
  ...
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}" :delete
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "gracePeriodSeconds" gracePeriodSeconds "orphanDependents" orphanDependents "propagationPolicy" propagationPolicy }
              :form-params   {}
...
(defn-spec delete-collection-cluster-role-with-http-info any?
  ...
  ([{:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" :delete
             {:path-params   {}
              :header-params {}
...
(defn-spec delete-collection-cluster-role-binding-with-http-info any?
  ...
  ([{:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings" :delete
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec delete-collection-namespaced-role-with-http-info any?
  ...
  ([namespace string?, {:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles" :delete
             {:path-params   {"namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec delete-collection-namespaced-role-binding-with-http-info any?
  ...
  ([namespace string?, {:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings" :delete
             {:path-params   {"namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec delete-namespaced-role-with-http-info any?
  ...
  ([name string?, namespace string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}" :delete
...
(defn-spec delete-namespaced-role-binding-with-http-info any?
  ...
  ([name string?, namespace string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}" :delete
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "gracePeriodSeconds" gracePeriodSeconds "orphanDependents" orphanDependents "propagationPolicy" propagationPolicy }
              :form-params   {}
...
(defn-spec get-api-resources-with-http-info any?
  ...
  []
  (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec list-cluster-role-with-http-info any?
  ...
  ([{:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-cluster-role v1alpha1/cluster-role-list-spec
  "
  list or watch objects of kind ClusterRole"
  ...
  ([optional-params any?]
   (let [res (:data (list-cluster-role-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/cluster-role-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-cluster-role-binding-with-http-info any?
  ...
  ([{:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-cluster-role-binding v1alpha1/cluster-role-binding-list-spec
  "
  list or watch objects of kind ClusterRoleBinding"
  ...
  ([optional-params any?]
   (let [res (:data (list-cluster-role-binding-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/cluster-role-binding-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-role-with-http-info any?
  ...
  ([namespace string?, {:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles" :get
             {:path-params   {"namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-namespaced-role v1alpha1/role-list-spec
  "
  list or watch objects of kind Role"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-role-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/role-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-role-binding-with-http-info any?
  ...
  ([namespace string?, {:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings" :get
             {:path-params   {"namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-namespaced-role-binding v1alpha1/role-binding-list-spec
  "
  list or watch objects of kind RoleBinding"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-role-binding-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/role-binding-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-role-binding-for-all-namespaces-with-http-info any?
  ...
  ([{:keys [continue fieldSelector labelSelector limit pretty resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/rolebindings" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec list-role-binding-for-all-namespaces v1alpha1/role-binding-list-spec
  "
  list or watch objects of kind RoleBinding"
...
(defn-spec list-role-for-all-namespaces-with-http-info any?
  ...
  ([{:keys [continue fieldSelector labelSelector limit pretty resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/roles" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "pretty" pretty "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-role-for-all-namespaces v1alpha1/role-list-spec
  "
  list or watch objects of kind Role"
...
(defn-spec patch-cluster-role-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec patch-cluster-role v1alpha1/cluster-role-spec
  "
  partially update the specified ClusterRole"
...
(defn-spec patch-cluster-role-binding-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-cluster-role-binding v1alpha1/cluster-role-binding-spec
  "
  partially update the specified ClusterRoleBinding"
...
(defn-spec patch-namespaced-role-with-http-info any?
  ...
  ([name string?, namespace string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}" :patch
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-namespaced-role v1alpha1/role-spec
  "
  partially update the specified Role"
...
(defn-spec patch-namespaced-role-binding-with-http-info any?
  ...
  ([name string?, namespace string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}" :patch
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-namespaced-role-binding v1alpha1/role-binding-spec
  "
  partially update the specified RoleBinding"
...
(defn-spec read-cluster-role-with-http-info any?
  ...
  ([name string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-cluster-role v1alpha1/cluster-role-spec
  "
  read the specified ClusterRole"
...
(defn-spec read-cluster-role-binding-with-http-info any?
  ...
  ([name string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec read-cluster-role-binding v1alpha1/cluster-role-binding-spec
  "
  read the specified ClusterRoleBinding"
...
(defn-spec read-namespaced-role-with-http-info any?
  ...
  ([name string?, namespace string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}" :get
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec read-namespaced-role v1alpha1/role-spec
  "
  read the specified Role"
...
(defn-spec read-namespaced-role-binding-with-http-info any?
  ...
  ([name string?, namespace string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}" :get
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec read-namespaced-role-binding v1alpha1/role-binding-spec
  "
  read the specified RoleBinding"
...
(defn-spec replace-cluster-role-with-http-info any?
  ...
  ([name string?, body v1alpha1/cluster-role, ] (replace-cluster-role-with-http-info name body nil))
  ([name string?, body v1alpha1/cluster-role, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-cluster-role v1alpha1/cluster-role-spec
  "
  replace the specified ClusterRole"
  ([name string?, body v1alpha1/cluster-role, ] (replace-cluster-role name body nil))
  ([name string?, body v1alpha1/cluster-role, optional-params any?]
...
(defn-spec replace-cluster-role-binding-with-http-info any?
  ...
  ([name string?, body v1alpha1/cluster-role-binding, ] (replace-cluster-role-binding-with-http-info name body nil))
  ([name string?, body v1alpha1/cluster-role-binding, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-cluster-role-binding v1alpha1/cluster-role-binding-spec
  "
  replace the specified ClusterRoleBinding"
  ([name string?, body v1alpha1/cluster-role-binding, ] (replace-cluster-role-binding name body nil))
  ([name string?, body v1alpha1/cluster-role-binding, optional-params any?]
...
(defn-spec replace-namespaced-role-with-http-info any?
  ...
  ([name string?, namespace string?, body v1alpha1/role, ] (replace-namespaced-role-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1alpha1/role, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}" :put
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-namespaced-role v1alpha1/role-spec
  "
  replace the specified Role"
  ([name string?, namespace string?, body v1alpha1/role, ] (replace-namespaced-role name namespace body nil))
  ([name string?, namespace string?, body v1alpha1/role, optional-params any?]
...
(defn-spec replace-namespaced-role-binding-with-http-info any?
  ...
  ([name string?, namespace string?, body v1alpha1/role-binding, ] (replace-namespaced-role-binding-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1alpha1/role-binding, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
   (call-api "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}" :put
             {:path-params   {"name" name "namespace" namespace }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-namespaced-role-binding v1alpha1/role-binding-spec
  "
  replace the specified RoleBinding"
  ([name string?, namespace string?, body v1alpha1/role-binding, ] (replace-namespaced-role-binding name namespace body nil))
  ([name string?, namespace string?, body v1alpha1/role-binding, optional-params any?]
