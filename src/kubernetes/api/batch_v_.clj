...
(defn-spec create-namespaced-job-with-http-info any?
  ...
  ([namespace string?, body v1/job, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-job v1/job-spec
  "
  create a Job"
  ...
  ([namespace string?, body v1/job, optional-params any?]
   (let [res (:data (create-namespaced-job-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/job-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-job v1/status-spec
  "
  delete collection of Job"
...
(defn-spec delete-namespaced-job-with-http-info any?
  "
  delete a Job"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-job-with-http-info name namespace body nil))
...
(defn-spec delete-namespaced-job v1/status-spec
  "
  delete a Job"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-job name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-job-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec list-job-for-all-namespaces v1/job-list-spec
  "
  list or watch objects of kind Job"
  ...
  ([optional-params any?]
   (let [res (:data (list-job-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/job-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-job v1/job-list-spec
  "
  list or watch objects of kind Job"
...
(defn-spec patch-namespaced-job v1/job-spec
  "
  partially update the specified Job"
...
(defn-spec patch-namespaced-job-status v1/job-spec
  "
  partially update status of the specified Job"
...
(defn-spec read-namespaced-job v1/job-spec
  "
  read the specified Job"
...
(defn-spec read-namespaced-job-status v1/job-spec
  "
  read status of the specified Job"
...
(defn-spec replace-namespaced-job-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/job, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-job v1/job-spec
  "
  replace the specified Job"
...
(defn-spec replace-namespaced-job-status v1/job-spec
  "
  replace status of the specified Job"
