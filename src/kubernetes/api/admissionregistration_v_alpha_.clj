(ns kubernetes.api.admissionregistration-v-alpha-
...
(defn-spec create-external-admission-hook-configuration-with-http-info any?
  "
  create an ExternalAdmissionHookConfiguration"
  ([body v1alpha1/external-admission-hook-configuration, ] (create-external-admission-hook-configuration-with-http-info body nil))
  ([body v1alpha1/external-admission-hook-configuration, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec create-external-admission-hook-configuration v1alpha1/external-admission-hook-configuration-spec
  "
  create an ExternalAdmissionHookConfiguration"
  ([body v1alpha1/external-admission-hook-configuration, ] (create-external-admission-hook-configuration body nil))
  ([body v1alpha1/external-admission-hook-configuration, optional-params any?]
   (let [res (:data (create-external-admission-hook-configuration-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/external-admission-hook-configuration-spec res st/string-transformer)
        res))))


(defn-spec create-initializer-configuration-with-http-info any?
  "
  create an InitializerConfiguration"
  ([body v1alpha1/initializer-configuration, ] (create-initializer-configuration-with-http-info body nil))
  ([body v1alpha1/initializer-configuration, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec create-initializer-configuration v1alpha1/initializer-configuration-spec
  "
  create an InitializerConfiguration"
  ([body v1alpha1/initializer-configuration, ] (create-initializer-configuration body nil))
  ([body v1alpha1/initializer-configuration, optional-params any?]
   (let [res (:data (create-initializer-configuration-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/initializer-configuration-spec res st/string-transformer)
        res))))


(defn-spec delete-collection-external-admission-hook-configuration-with-http-info any?
  "
  delete collection of ExternalAdmissionHookConfiguration"
  ([] (delete-collection-external-admission-hook-configuration-with-http-info nil))
  ([{:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations" :delete
             {:path-params   {}
              :header-params {}
...
(defn-spec delete-collection-external-admission-hook-configuration v1/status-spec
  "
  delete collection of ExternalAdmissionHookConfiguration"
  ([] (delete-collection-external-admission-hook-configuration nil))
  ([optional-params any?]
   (let [res (:data (delete-collection-external-admission-hook-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))


(defn-spec delete-collection-initializer-configuration-with-http-info any?
  "
  delete collection of InitializerConfiguration"
  ([] (delete-collection-initializer-configuration-with-http-info nil))
  ([{:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations" :delete
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "includeUninitialized" includeUninitialized "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec delete-collection-initializer-configuration v1/status-spec
  "
  delete collection of InitializerConfiguration"
  ([] (delete-collection-initializer-configuration nil))
  ([optional-params any?]
   (let [res (:data (delete-collection-initializer-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))


(defn-spec delete-external-admission-hook-configuration-with-http-info any?
  "
  delete an ExternalAdmissionHookConfiguration"
  ([name string?, body v1/delete-options, ] (delete-external-admission-hook-configuration-with-http-info name body nil))
  ([name string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations/{name}" :delete
...
(defn-spec delete-external-admission-hook-configuration v1/status-spec
  "
  delete an ExternalAdmissionHookConfiguration"
  ([name string?, body v1/delete-options, ] (delete-external-admission-hook-configuration name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-external-admission-hook-configuration-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))


(defn-spec delete-initializer-configuration-with-http-info any?
  "
  delete an InitializerConfiguration"
  ([name string?, body v1/delete-options, ] (delete-initializer-configuration-with-http-info name body nil))
  ([name string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}" :delete
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "gracePeriodSeconds" gracePeriodSeconds "orphanDependents" orphanDependents "propagationPolicy" propagationPolicy }
              :form-params   {}
...
(defn-spec delete-initializer-configuration v1/status-spec
  "
  delete an InitializerConfiguration"
  ([name string?, body v1/delete-options, ] (delete-initializer-configuration name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-initializer-configuration-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec get-api-resources-with-http-info any?
  ...
  []
  (call-api "/apis/admissionregistration.k8s.io/v1alpha1/" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec list-external-admission-hook-configuration-with-http-info any?
  "
  list or watch objects of kind ExternalAdmissionHookConfiguration"
  ([] (list-external-admission-hook-configuration-with-http-info nil))
  ([{:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "includeUninitialized" includeUninitialized "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-external-admission-hook-configuration v1alpha1/external-admission-hook-configuration-list-spec
  "
  list or watch objects of kind ExternalAdmissionHookConfiguration"
  ([] (list-external-admission-hook-configuration nil))
  ([optional-params any?]
   (let [res (:data (list-external-admission-hook-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/external-admission-hook-configuration-list-spec res st/string-transformer)
        res))))


(defn-spec list-initializer-configuration-with-http-info any?
  "
  list or watch objects of kind InitializerConfiguration"
  ([] (list-initializer-configuration-with-http-info nil))
  ([{:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "includeUninitialized" includeUninitialized "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-initializer-configuration v1alpha1/initializer-configuration-list-spec
  "
  list or watch objects of kind InitializerConfiguration"
  ([] (list-initializer-configuration nil))
  ([optional-params any?]
   (let [res (:data (list-initializer-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/initializer-configuration-list-spec res st/string-transformer)
        res))))


(defn-spec patch-external-admission-hook-configuration-with-http-info any?
  "
  partially update the specified ExternalAdmissionHookConfiguration"
  ([name string?, body any?, ] (patch-external-admission-hook-configuration-with-http-info name body nil))
  ([name string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec patch-external-admission-hook-configuration v1alpha1/external-admission-hook-configuration-spec
  "
  partially update the specified ExternalAdmissionHookConfiguration"
  ([name string?, body any?, ] (patch-external-admission-hook-configuration name body nil))
  ([name string?, body any?, optional-params any?]
   (let [res (:data (patch-external-admission-hook-configuration-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/external-admission-hook-configuration-spec res st/string-transformer)
        res))))


(defn-spec patch-initializer-configuration-with-http-info any?
  "
  partially update the specified InitializerConfiguration"
  ([name string?, body any?, ] (patch-initializer-configuration-with-http-info name body nil))
  ([name string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec patch-initializer-configuration v1alpha1/initializer-configuration-spec
  "
  partially update the specified InitializerConfiguration"
  ([name string?, body any?, ] (patch-initializer-configuration name body nil))
  ([name string?, body any?, optional-params any?]
   (let [res (:data (patch-initializer-configuration-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/initializer-configuration-spec res st/string-transformer)
        res))))


(defn-spec read-external-admission-hook-configuration-with-http-info any?
  "
  read the specified ExternalAdmissionHookConfiguration"
  ([name string?, ] (read-external-admission-hook-configuration-with-http-info name nil))
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-external-admission-hook-configuration v1alpha1/external-admission-hook-configuration-spec
  "
  read the specified ExternalAdmissionHookConfiguration"
  ([name string?, ] (read-external-admission-hook-configuration name nil))
  ([name string?, optional-params any?]
   (let [res (:data (read-external-admission-hook-configuration-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/external-admission-hook-configuration-spec res st/string-transformer)
        res))))


(defn-spec read-initializer-configuration-with-http-info any?
  "
  read the specified InitializerConfiguration"
  ([name string?, ] (read-initializer-configuration-with-http-info name nil))
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "exact" exact "export" export }
              :form-params   {}
...
(defn-spec read-initializer-configuration v1alpha1/initializer-configuration-spec
  "
  read the specified InitializerConfiguration"
  ([name string?, ] (read-initializer-configuration name nil))
  ([name string?, optional-params any?]
   (let [res (:data (read-initializer-configuration-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/initializer-configuration-spec res st/string-transformer)
        res))))


(defn-spec replace-external-admission-hook-configuration-with-http-info any?
  "
  replace the specified ExternalAdmissionHookConfiguration"
  ([name string?, body v1alpha1/external-admission-hook-configuration, ] (replace-external-admission-hook-configuration-with-http-info name body nil))
  ([name string?, body v1alpha1/external-admission-hook-configuration, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec replace-external-admission-hook-configuration v1alpha1/external-admission-hook-configuration-spec
  "
  replace the specified ExternalAdmissionHookConfiguration"
  ([name string?, body v1alpha1/external-admission-hook-configuration, ] (replace-external-admission-hook-configuration name body nil))
  ([name string?, body v1alpha1/external-admission-hook-configuration, optional-params any?]
   (let [res (:data (replace-external-admission-hook-configuration-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/external-admission-hook-configuration-spec res st/string-transformer)
        res))))


(defn-spec replace-initializer-configuration-with-http-info any?
  "
  replace the specified InitializerConfiguration"
  ([name string?, body v1alpha1/initializer-configuration, ] (replace-initializer-configuration-with-http-info name body nil))
  ([name string?, body v1alpha1/initializer-configuration, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec replace-initializer-configuration v1alpha1/initializer-configuration-spec
  "
  replace the specified InitializerConfiguration"
  ([name string?, body v1alpha1/initializer-configuration, ] (replace-initializer-configuration name body nil))
  ([name string?, body v1alpha1/initializer-configuration, optional-params any?]
   (let [res (:data (replace-initializer-configuration-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/initializer-configuration-spec res st/string-transformer)
        res))))
