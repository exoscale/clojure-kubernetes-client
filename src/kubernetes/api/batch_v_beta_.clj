...
(defn-spec create-namespaced-cron-job-with-http-info any?
  "
  create a CronJob"
  ([namespace string?, body v1beta1/cron-job, ] (create-namespaced-cron-job-with-http-info namespace body nil))
  ([namespace string?, body v1beta1/cron-job, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-cron-job v1beta1/cron-job-spec
  "
  create a CronJob"
  ([namespace string?, body v1beta1/cron-job, ] (create-namespaced-cron-job namespace body nil))
  ([namespace string?, body v1beta1/cron-job, optional-params any?]
   (let [res (:data (create-namespaced-cron-job-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/cron-job-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-cron-job v1/status-spec
  "
  delete collection of CronJob"
...
(defn-spec delete-namespaced-cron-job-with-http-info any?
  "
  delete a CronJob"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-cron-job-with-http-info name namespace body nil))
...
(defn-spec delete-namespaced-cron-job v1/status-spec
  "
  delete a CronJob"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-cron-job name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-cron-job-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec list-cron-job-for-all-namespaces v1beta1/cron-job-list-spec
  "
  list or watch objects of kind CronJob"
  ...
  ([optional-params any?]
   (let [res (:data (list-cron-job-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/cron-job-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-cron-job v1beta1/cron-job-list-spec
  "
  list or watch objects of kind CronJob"
...
(defn-spec patch-namespaced-cron-job v1beta1/cron-job-spec
  "
  partially update the specified CronJob"
...
(defn-spec patch-namespaced-cron-job-status v1beta1/cron-job-spec
  "
  partially update status of the specified CronJob"
...
(defn-spec read-namespaced-cron-job v1beta1/cron-job-spec
  "
  read the specified CronJob"
...
(defn-spec read-namespaced-cron-job-status v1beta1/cron-job-spec
  "
  read status of the specified CronJob"
...
(defn-spec replace-namespaced-cron-job-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/cron-job, ] (replace-namespaced-cron-job-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta1/cron-job, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-cron-job v1beta1/cron-job-spec
  "
  replace the specified CronJob"
  ([name string?, namespace string?, body v1beta1/cron-job, ] (replace-namespaced-cron-job name namespace body nil))
  ([name string?, namespace string?, body v1beta1/cron-job, optional-params any?]
...
(defn-spec replace-namespaced-cron-job-status-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/cron-job, ] (replace-namespaced-cron-job-status-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta1/cron-job, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-cron-job-status v1beta1/cron-job-spec
  "
  replace status of the specified CronJob"
  ([name string?, namespace string?, body v1beta1/cron-job, ] (replace-namespaced-cron-job-status name namespace body nil))
  ([name string?, namespace string?, body v1beta1/cron-job, optional-params any?]
