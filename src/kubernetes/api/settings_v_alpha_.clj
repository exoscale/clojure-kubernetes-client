(ns kubernetes.api.settings-v-alpha-
...
(defn-spec create-namespaced-pod-preset-with-http-info any?
  ...
  ([namespace string?, body v1alpha1/pod-preset, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-pod-preset v1alpha1/pod-preset-spec
  "
  create a PodPreset"
  ...
  ([namespace string?, body v1alpha1/pod-preset, optional-params any?]
   (let [res (:data (create-namespaced-pod-preset-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/pod-preset-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-pod-preset v1/status-spec
  "
  delete collection of PodPreset"
...
(defn-spec delete-namespaced-pod-preset-with-http-info any?
  "
  delete a PodPreset"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-preset-with-http-info name namespace body nil))
...
(defn-spec delete-namespaced-pod-preset v1/status-spec
  "
  delete a PodPreset"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-pod-preset name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-pod-preset-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-pod-preset v1alpha1/pod-preset-list-spec
  "
  list or watch objects of kind PodPreset"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-pod-preset-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/pod-preset-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-pod-preset-for-all-namespaces v1alpha1/pod-preset-list-spec
  "
  list or watch objects of kind PodPreset"
...
(defn-spec patch-namespaced-pod-preset v1alpha1/pod-preset-spec
  "
  partially update the specified PodPreset"
...
(defn-spec read-namespaced-pod-preset v1alpha1/pod-preset-spec
  "
  read the specified PodPreset"
...
(defn-spec replace-namespaced-pod-preset-with-http-info any?
  ...
  ([name string?, namespace string?, body v1alpha1/pod-preset, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-pod-preset v1alpha1/pod-preset-spec
  "
  replace the specified PodPreset"
