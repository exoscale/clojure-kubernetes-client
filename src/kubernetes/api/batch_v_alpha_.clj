(ns kubernetes.api.batch-v-alpha-
...
(defn-spec create-namespaced-cron-job-with-http-info any?
  ...
  ([namespace string?, body v2alpha1/cron-job, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-cron-job v2alpha1/cron-job-spec
  "
  create a CronJob"
  ...
  ([namespace string?, body v2alpha1/cron-job, optional-params any?]
   (let [res (:data (create-namespaced-cron-job-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v2alpha1/cron-job-spec res st/string-transformer)
        res))))
...
(defn-spec list-cron-job-for-all-namespaces v2alpha1/cron-job-list-spec
  "
  list or watch objects of kind CronJob"
  ...
  ([optional-params any?]
   (let [res (:data (list-cron-job-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v2alpha1/cron-job-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-cron-job v2alpha1/cron-job-list-spec
  "
  list or watch objects of kind CronJob"
...
(defn-spec patch-namespaced-cron-job v2alpha1/cron-job-spec
  "
  partially update the specified CronJob"
...
(defn-spec patch-namespaced-cron-job-status v2alpha1/cron-job-spec
  "
  partially update status of the specified CronJob"
...
(defn-spec read-namespaced-cron-job v2alpha1/cron-job-spec
  "
  read the specified CronJob"
...
(defn-spec read-namespaced-cron-job-status v2alpha1/cron-job-spec
  "
  read status of the specified CronJob"
...
(defn-spec replace-namespaced-cron-job-with-http-info any?
  ...
  ([name string?, namespace string?, body v2alpha1/cron-job, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-cron-job v2alpha1/cron-job-spec
  "
  replace the specified CronJob"
...
(defn-spec replace-namespaced-cron-job-status v2alpha1/cron-job-spec
  "
  replace status of the specified CronJob"
