...
(defn-spec create-namespaced-controller-revision-with-http-info any?
  ...
  ([namespace string?, body v1beta1/controller-revision, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-controller-revision v1beta1/controller-revision-spec
  "
  create a ControllerRevision"
  ...
  ([namespace string?, body v1beta1/controller-revision, optional-params any?]
   (let [res (:data (create-namespaced-controller-revision-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/controller-revision-spec res st/string-transformer)
        res))))


(defn-spec create-namespaced-controller-revision_0-with-http-info any?
  "
  create a ControllerRevision"
  ([namespace string?, body v1beta2/controller-revision, ] (create-namespaced-controller-revision_0-with-http-info namespace body nil))
  ([namespace string?, body v1beta2/controller-revision, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-controller-revision_0 v1beta2/controller-revision-spec
  "
  create a ControllerRevision"
  ([namespace string?, body v1beta2/controller-revision, ] (create-namespaced-controller-revision_0 namespace body nil))
  ([namespace string?, body v1beta2/controller-revision, optional-params any?]
   (let [res (:data (create-namespaced-controller-revision_0-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/controller-revision-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-daemon-set-with-http-info any?
  "
  create a DaemonSet"
  ([namespace string?, body v1beta2/daemon-set, ] (create-namespaced-daemon-set-with-http-info namespace body nil))
  ([namespace string?, body v1beta2/daemon-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-daemon-set v1beta2/daemon-set-spec
  "
  create a DaemonSet"
  ([namespace string?, body v1beta2/daemon-set, ] (create-namespaced-daemon-set namespace body nil))
  ([namespace string?, body v1beta2/daemon-set, optional-params any?]
   (let [res (:data (create-namespaced-daemon-set-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/daemon-set-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-deployment-with-http-info any?
  ...
  ([namespace string?, body apps/v1beta1/deployment, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-deployment apps/v1beta1/deployment-spec
  "
  create a Deployment"
  ...
  ([namespace string?, body apps/v1beta1/deployment, optional-params any?]
   (let [res (:data (create-namespaced-deployment-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode apps/v1beta1/deployment-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-deployment-rollback-with-http-info any?
  ...
  ([name string?, namespace string?, body apps/v1beta1/deployment-rollback, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-deployment-rollback apps/v1beta1/deployment-rollback-spec
  "
  create rollback of a Deployment"
  ...
  ([name string?, namespace string?, body apps/v1beta1/deployment-rollback, optional-params any?]
   (let [res (:data (create-namespaced-deployment-rollback-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode apps/v1beta1/deployment-rollback-spec res st/string-transformer)
        res))))


(defn-spec create-namespaced-deployment_0-with-http-info any?
  "
  create a Deployment"
  ([namespace string?, body v1beta2/deployment, ] (create-namespaced-deployment_0-with-http-info namespace body nil))
  ([namespace string?, body v1beta2/deployment, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-deployment_0 v1beta2/deployment-spec
  "
  create a Deployment"
  ([namespace string?, body v1beta2/deployment, ] (create-namespaced-deployment_0 namespace body nil))
  ([namespace string?, body v1beta2/deployment, optional-params any?]
   (let [res (:data (create-namespaced-deployment_0-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-replica-set-with-http-info any?
  "
  create a ReplicaSet"
  ([namespace string?, body v1beta2/replica-set, ] (create-namespaced-replica-set-with-http-info namespace body nil))
  ([namespace string?, body v1beta2/replica-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-replica-set v1beta2/replica-set-spec
  "
  create a ReplicaSet"
  ([namespace string?, body v1beta2/replica-set, ] (create-namespaced-replica-set namespace body nil))
  ([namespace string?, body v1beta2/replica-set, optional-params any?]
   (let [res (:data (create-namespaced-replica-set-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/replica-set-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-stateful-set-with-http-info any?
  ...
  ([namespace string?, body v1beta1/stateful-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-stateful-set v1beta1/stateful-set-spec
  "
  create a StatefulSet"
  ...
  ([namespace string?, body v1beta1/stateful-set, optional-params any?]
   (let [res (:data (create-namespaced-stateful-set-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/stateful-set-spec res st/string-transformer)
        res))))


(defn-spec create-namespaced-stateful-set_0-with-http-info any?
  "
  create a StatefulSet"
  ([namespace string?, body v1beta2/stateful-set, ] (create-namespaced-stateful-set_0-with-http-info namespace body nil))
  ([namespace string?, body v1beta2/stateful-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-stateful-set_0 v1beta2/stateful-set-spec
  "
  create a StatefulSet"
  ([namespace string?, body v1beta2/stateful-set, ] (create-namespaced-stateful-set_0 namespace body nil))
  ([namespace string?, body v1beta2/stateful-set, optional-params any?]
   (let [res (:data (create-namespaced-stateful-set_0-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-controller-revision v1/status-spec
  "
  delete collection of ControllerRevision"
...
(defn-spec delete-collection-namespaced-controller-revision_0-with-http-info any?
  "
  delete collection of ControllerRevision"
  ([namespace string?, ] (delete-collection-namespaced-controller-revision_0-with-http-info namespace nil))
  ([namespace string?, {:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
...
(defn-spec delete-collection-namespaced-controller-revision_0 v1/status-spec
  "
  delete collection of ControllerRevision"
  ([namespace string?, ] (delete-collection-namespaced-controller-revision_0 namespace nil))
  ([namespace string?, optional-params any?]
   (let [res (:data (delete-collection-namespaced-controller-revision_0-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-deployment_0-with-http-info any?
  "
  delete collection of Deployment"
  ([namespace string?, ] (delete-collection-namespaced-deployment_0-with-http-info namespace nil))
  ([namespace string?, {:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
...
(defn-spec delete-collection-namespaced-deployment_0 v1/status-spec
  "
  delete collection of Deployment"
  ([namespace string?, ] (delete-collection-namespaced-deployment_0 namespace nil))
  ([namespace string?, optional-params any?]
   (let [res (:data (delete-collection-namespaced-deployment_0-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-namespaced-stateful-set v1/status-spec
  "
  delete collection of StatefulSet"
...
(defn-spec delete-collection-namespaced-stateful-set_0-with-http-info any?
  "
  delete collection of StatefulSet"
  ([namespace string?, ] (delete-collection-namespaced-stateful-set_0-with-http-info namespace nil))
  ([namespace string?, {:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
...
(defn-spec delete-collection-namespaced-stateful-set_0 v1/status-spec
  "
  delete collection of StatefulSet"
  ([namespace string?, ] (delete-collection-namespaced-stateful-set_0 namespace nil))
  ([namespace string?, optional-params any?]
   (let [res (:data (delete-collection-namespaced-stateful-set_0-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-controller-revision-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-controller-revision-with-http-info name namespace body nil))
...
(defn-spec delete-namespaced-controller-revision v1/status-spec
  "
  delete a ControllerRevision"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-controller-revision name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-controller-revision-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))


(defn-spec delete-namespaced-controller-revision_0-with-http-info any?
  "
  delete a ControllerRevision"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-controller-revision_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-controller-revision_0 v1/status-spec
  "
  delete a ControllerRevision"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-controller-revision_0 name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-controller-revision_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-deployment_0-with-http-info any?
  "
  delete a Deployment"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-deployment_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-deployment_0 v1/status-spec
  "
  delete a Deployment"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-deployment_0 name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-deployment_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-stateful-set-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-stateful-set-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-stateful-set v1/status-spec
  "
  delete a StatefulSet"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-stateful-set name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-stateful-set-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))


(defn-spec delete-namespaced-stateful-set_0-with-http-info any?
  "
  delete a StatefulSet"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-stateful-set_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, {:keys [pretty gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec delete-namespaced-stateful-set_0 v1/status-spec
  "
  delete a StatefulSet"
  ([name string?, namespace string?, body v1/delete-options, ] (delete-namespaced-stateful-set_0 name namespace body nil))
  ([name string?, namespace string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-stateful-set_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec get-api-resources_0-with-http-info any?
  "
  get available resources"
  []
...
(defn-spec get-api-resources_0 v1/api-resource-list-spec
  "
  get available resources"
  []
  (let [res (:data (get-api-resources_0-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode v1/api-resource-list-spec res st/string-transformer)
       res)))
...
(defn-spec list-controller-revision-for-all-namespaces v1beta1/controller-revision-list-spec
  "
  list or watch objects of kind ControllerRevision"
  ...
  ([optional-params any?]
   (let [res (:data (list-controller-revision-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/controller-revision-list-spec res st/string-transformer)
        res))))


(defn-spec list-controller-revision-for-all-namespaces_0-with-http-info any?
  "
  list or watch objects of kind ControllerRevision"
  ([] (list-controller-revision-for-all-namespaces_0-with-http-info nil))
  ([{:keys [continue fieldSelector includeUninitialized labelSelector limit pretty resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
...
(defn-spec list-controller-revision-for-all-namespaces_0 v1beta2/controller-revision-list-spec
  "
  list or watch objects of kind ControllerRevision"
  ([] (list-controller-revision-for-all-namespaces_0 nil))
  ([optional-params any?]
   (let [res (:data (list-controller-revision-for-all-namespaces_0-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/controller-revision-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-daemon-set-for-all-namespaces v1beta2/daemon-set-list-spec
  "
  list or watch objects of kind DaemonSet"
  ...
  ([optional-params any?]
   (let [res (:data (list-daemon-set-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/daemon-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-deployment-for-all-namespaces apps/v1beta1/deployment-list-spec
  "
  list or watch objects of kind Deployment"
  ...
  ([optional-params any?]
   (let [res (:data (list-deployment-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode apps/v1beta1/deployment-list-spec res st/string-transformer)
        res))))


(defn-spec list-deployment-for-all-namespaces_0-with-http-info any?
  "
  list or watch objects of kind Deployment"
  ([] (list-deployment-for-all-namespaces_0-with-http-info nil))
  ([{:keys [continue fieldSelector includeUninitialized labelSelector limit pretty resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
...
(defn-spec list-deployment-for-all-namespaces_0 v1beta2/deployment-list-spec
  "
  list or watch objects of kind Deployment"
  ([] (list-deployment-for-all-namespaces_0 nil))
  ([optional-params any?]
   (let [res (:data (list-deployment-for-all-namespaces_0-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-controller-revision v1beta1/controller-revision-list-spec
  "
  list or watch objects of kind ControllerRevision"
...
(defn-spec list-namespaced-controller-revision_0-with-http-info any?
  "
  list or watch objects of kind ControllerRevision"
  ([namespace string?, ] (list-namespaced-controller-revision_0-with-http-info namespace nil))
  ([namespace string?, {:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
...
(defn-spec list-namespaced-controller-revision_0 v1beta2/controller-revision-list-spec
  "
  list or watch objects of kind ControllerRevision"
  ([namespace string?, ] (list-namespaced-controller-revision_0 namespace nil))
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-controller-revision_0-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/controller-revision-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-daemon-set v1beta2/daemon-set-list-spec
  "
  list or watch objects of kind DaemonSet"
...
(defn-spec list-namespaced-deployment apps/v1beta1/deployment-list-spec
  "
  list or watch objects of kind Deployment"
...
(defn-spec list-namespaced-deployment_0-with-http-info any?
  "
  list or watch objects of kind Deployment"
  ([namespace string?, ] (list-namespaced-deployment_0-with-http-info namespace nil))
  ([namespace string?, {:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
...
(defn-spec list-namespaced-deployment_0 v1beta2/deployment-list-spec
  "
  list or watch objects of kind Deployment"
  ([namespace string?, ] (list-namespaced-deployment_0 namespace nil))
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-deployment_0-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-replica-set v1beta2/replica-set-list-spec
  "
  list or watch objects of kind ReplicaSet"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-replica-set-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/replica-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-stateful-set v1beta1/stateful-set-list-spec
  "
  list or watch objects of kind StatefulSet"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-stateful-set-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/stateful-set-list-spec res st/string-transformer)
        res))))


(defn-spec list-namespaced-stateful-set_0-with-http-info any?
  "
  list or watch objects of kind StatefulSet"
  ([namespace string?, ] (list-namespaced-stateful-set_0-with-http-info namespace nil))
  ([namespace string?, {:keys [pretty continue fieldSelector includeUninitialized labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params namespace)
...
(defn-spec list-namespaced-stateful-set_0 v1beta2/stateful-set-list-spec
  "
  list or watch objects of kind StatefulSet"
  ([namespace string?, ] (list-namespaced-stateful-set_0 namespace nil))
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-stateful-set_0-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-replica-set-for-all-namespaces v1beta2/replica-set-list-spec
  "
  list or watch objects of kind ReplicaSet"
...
(defn-spec list-stateful-set-for-all-namespaces v1beta1/stateful-set-list-spec
  "
  list or watch objects of kind StatefulSet"
...
(defn-spec list-stateful-set-for-all-namespaces_0-with-http-info any?
  "
  list or watch objects of kind StatefulSet"
  ([] (list-stateful-set-for-all-namespaces_0-with-http-info nil))
  ([{:keys [continue fieldSelector includeUninitialized labelSelector limit pretty resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
...
(defn-spec list-stateful-set-for-all-namespaces_0 v1beta2/stateful-set-list-spec
  "
  list or watch objects of kind StatefulSet"
  ([] (list-stateful-set-for-all-namespaces_0 nil))
  ([optional-params any?]
   (let [res (:data (list-stateful-set-for-all-namespaces_0-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-controller-revision v1beta1/controller-revision-spec
  "
  partially update the specified ControllerRevision"
...
(defn-spec patch-namespaced-controller-revision_0-with-http-info any?
  "
  partially update the specified ControllerRevision"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-controller-revision_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-controller-revision_0 v1beta2/controller-revision-spec
  "
  partially update the specified ControllerRevision"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-controller-revision_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-controller-revision_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/controller-revision-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-daemon-set v1beta2/daemon-set-spec
  "
  partially update the specified DaemonSet"
...
(defn-spec patch-namespaced-daemon-set-status v1beta2/daemon-set-spec
  "
  partially update status of the specified DaemonSet"
...
(defn-spec patch-namespaced-deployment apps/v1beta1/deployment-spec
  "
  partially update the specified Deployment"
...
(defn-spec patch-namespaced-deployment-scale apps/v1beta1/scale-spec
  "
  partially update scale of the specified Deployment"
  ...
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-deployment-scale-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode apps/v1beta1/scale-spec res st/string-transformer)
        res))))


(defn-spec patch-namespaced-deployment-scale_0-with-http-info any?
  "
  partially update scale of the specified Deployment"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-deployment-scale_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-deployment-scale_0 v1beta2/scale-spec
  "
  partially update scale of the specified Deployment"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-deployment-scale_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-deployment-scale_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/scale-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-deployment-status apps/v1beta1/deployment-spec
  "
  partially update status of the specified Deployment"
...
(defn-spec patch-namespaced-deployment-status_0-with-http-info any?
  "
  partially update status of the specified Deployment"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-deployment-status_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-deployment-status_0 v1beta2/deployment-spec
  "
  partially update status of the specified Deployment"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-deployment-status_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-deployment-status_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))


(defn-spec patch-namespaced-deployment_0-with-http-info any?
  "
  partially update the specified Deployment"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-deployment_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-deployment_0 v1beta2/deployment-spec
  "
  partially update the specified Deployment"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-deployment_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-deployment_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-replica-set v1beta2/replica-set-spec
  "
  partially update the specified ReplicaSet"
...
(defn-spec patch-namespaced-replica-set-scale v1beta2/scale-spec
  "
  partially update scale of the specified ReplicaSet"
...
(defn-spec patch-namespaced-replica-set-status v1beta2/replica-set-spec
  "
  partially update status of the specified ReplicaSet"
...
(defn-spec patch-namespaced-stateful-set v1beta1/stateful-set-spec
  "
  partially update the specified StatefulSet"
...
(defn-spec patch-namespaced-stateful-set-scale apps/v1beta1/scale-spec
  "
  partially update scale of the specified StatefulSet"
...
(defn-spec patch-namespaced-stateful-set-scale_0-with-http-info any?
  "
  partially update scale of the specified StatefulSet"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-stateful-set-scale_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-stateful-set-scale_0 v1beta2/scale-spec
  "
  partially update scale of the specified StatefulSet"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-stateful-set-scale_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-stateful-set-scale_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/scale-spec res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-stateful-set-status v1beta1/stateful-set-spec
  "
  partially update status of the specified StatefulSet"
...
(defn-spec patch-namespaced-stateful-set-status_0-with-http-info any?
  "
  partially update status of the specified StatefulSet"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-stateful-set-status_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-stateful-set-status_0 v1beta2/stateful-set-spec
  "
  partially update status of the specified StatefulSet"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-stateful-set-status_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-stateful-set-status_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))


(defn-spec patch-namespaced-stateful-set_0-with-http-info any?
  "
  partially update the specified StatefulSet"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-stateful-set_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body any?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec patch-namespaced-stateful-set_0 v1beta2/stateful-set-spec
  "
  partially update the specified StatefulSet"
  ([name string?, namespace string?, body any?, ] (patch-namespaced-stateful-set_0 name namespace body nil))
  ([name string?, namespace string?, body any?, optional-params any?]
   (let [res (:data (patch-namespaced-stateful-set_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))
...
(defn-spec read-namespaced-controller-revision v1beta1/controller-revision-spec
  "
  read the specified ControllerRevision"
...
(defn-spec read-namespaced-controller-revision_0-with-http-info any?
  "
  read the specified ControllerRevision"
  ([name string?, namespace string?, ] (read-namespaced-controller-revision_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-controller-revision_0 v1beta2/controller-revision-spec
  "
  read the specified ControllerRevision"
  ([name string?, namespace string?, ] (read-namespaced-controller-revision_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-controller-revision_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/controller-revision-spec res st/string-transformer)
        res))))
...
(defn-spec read-namespaced-daemon-set v1beta2/daemon-set-spec
  "
  read the specified DaemonSet"
...
(defn-spec read-namespaced-daemon-set-status v1beta2/daemon-set-spec
  "
  read status of the specified DaemonSet"
...
(defn-spec read-namespaced-deployment apps/v1beta1/deployment-spec
  "
  read the specified Deployment"
...
(defn-spec read-namespaced-deployment-scale apps/v1beta1/scale-spec
  "
  read scale of the specified Deployment"
...
(defn-spec read-namespaced-deployment-scale_0-with-http-info any?
  "
  read scale of the specified Deployment"
  ([name string?, namespace string?, ] (read-namespaced-deployment-scale_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-deployment-scale_0 v1beta2/scale-spec
  "
  read scale of the specified Deployment"
  ([name string?, namespace string?, ] (read-namespaced-deployment-scale_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-deployment-scale_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/scale-spec res st/string-transformer)
        res))))
...
(defn-spec read-namespaced-deployment-status apps/v1beta1/deployment-spec
  "
  read status of the specified Deployment"
...
(defn-spec read-namespaced-deployment-status_0-with-http-info any?
  "
  read status of the specified Deployment"
  ([name string?, namespace string?, ] (read-namespaced-deployment-status_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-deployment-status_0 v1beta2/deployment-spec
  "
  read status of the specified Deployment"
  ([name string?, namespace string?, ] (read-namespaced-deployment-status_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-deployment-status_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))


(defn-spec read-namespaced-deployment_0-with-http-info any?
  "
  read the specified Deployment"
  ([name string?, namespace string?, ] (read-namespaced-deployment_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-deployment_0 v1beta2/deployment-spec
  "
  read the specified Deployment"
  ([name string?, namespace string?, ] (read-namespaced-deployment_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-deployment_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))
...
(defn-spec read-namespaced-replica-set v1beta2/replica-set-spec
  "
  read the specified ReplicaSet"
...
(defn-spec read-namespaced-replica-set-scale v1beta2/scale-spec
  "
  read scale of the specified ReplicaSet"
...
(defn-spec read-namespaced-replica-set-status v1beta2/replica-set-spec
  "
  read status of the specified ReplicaSet"
...
(defn-spec read-namespaced-stateful-set v1beta1/stateful-set-spec
  "
  read the specified StatefulSet"
...
(defn-spec read-namespaced-stateful-set-scale apps/v1beta1/scale-spec
  "
  read scale of the specified StatefulSet"
...
(defn-spec read-namespaced-stateful-set-scale_0-with-http-info any?
  "
  read scale of the specified StatefulSet"
  ([name string?, namespace string?, ] (read-namespaced-stateful-set-scale_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-stateful-set-scale_0 v1beta2/scale-spec
  "
  read scale of the specified StatefulSet"
  ([name string?, namespace string?, ] (read-namespaced-stateful-set-scale_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-stateful-set-scale_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/scale-spec res st/string-transformer)
        res))))
...
(defn-spec read-namespaced-stateful-set-status v1beta1/stateful-set-spec
  "
  read status of the specified StatefulSet"
...
(defn-spec read-namespaced-stateful-set-status_0-with-http-info any?
  "
  read status of the specified StatefulSet"
  ([name string?, namespace string?, ] (read-namespaced-stateful-set-status_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-stateful-set-status_0 v1beta2/stateful-set-spec
  "
  read status of the specified StatefulSet"
  ([name string?, namespace string?, ] (read-namespaced-stateful-set-status_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-stateful-set-status_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))


(defn-spec read-namespaced-stateful-set_0-with-http-info any?
  "
  read the specified StatefulSet"
  ([name string?, namespace string?, ] (read-namespaced-stateful-set_0-with-http-info name namespace nil))
  ([name string?, namespace string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name namespace)
...
(defn-spec read-namespaced-stateful-set_0 v1beta2/stateful-set-spec
  "
  read the specified StatefulSet"
  ([name string?, namespace string?, ] (read-namespaced-stateful-set_0 name namespace nil))
  ([name string?, namespace string?, optional-params any?]
   (let [res (:data (read-namespaced-stateful-set_0-with-http-info name namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-controller-revision-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/controller-revision, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-controller-revision v1beta1/controller-revision-spec
  "
  replace the specified ControllerRevision"
...
(defn-spec replace-namespaced-controller-revision_0-with-http-info any?
  "
  replace the specified ControllerRevision"
  ([name string?, namespace string?, body v1beta2/controller-revision, ] (replace-namespaced-controller-revision_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/controller-revision, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-controller-revision_0 v1beta2/controller-revision-spec
  "
  replace the specified ControllerRevision"
  ([name string?, namespace string?, body v1beta2/controller-revision, ] (replace-namespaced-controller-revision_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/controller-revision, optional-params any?]
   (let [res (:data (replace-namespaced-controller-revision_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/controller-revision-spec res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-daemon-set-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta2/daemon-set, ] (replace-namespaced-daemon-set-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/daemon-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-daemon-set v1beta2/daemon-set-spec
  "
  replace the specified DaemonSet"
  ([name string?, namespace string?, body v1beta2/daemon-set, ] (replace-namespaced-daemon-set name namespace body nil))
  ([name string?, namespace string?, body v1beta2/daemon-set, optional-params any?]
...
(defn-spec replace-namespaced-daemon-set-status-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta2/daemon-set, ] (replace-namespaced-daemon-set-status-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/daemon-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-daemon-set-status v1beta2/daemon-set-spec
  "
  replace status of the specified DaemonSet"
  ([name string?, namespace string?, body v1beta2/daemon-set, ] (replace-namespaced-daemon-set-status name namespace body nil))
  ([name string?, namespace string?, body v1beta2/daemon-set, optional-params any?]
...
(defn-spec replace-namespaced-deployment-with-http-info any?
  ...
  ([name string?, namespace string?, body apps/v1beta1/deployment, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-deployment apps/v1beta1/deployment-spec
  "
  replace the specified Deployment"
...
(defn-spec replace-namespaced-deployment-scale-with-http-info any?
  ...
  ([name string?, namespace string?, body apps/v1beta1/scale, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-deployment-scale apps/v1beta1/scale-spec
  "
  replace scale of the specified Deployment"
...
(defn-spec replace-namespaced-deployment-scale_0-with-http-info any?
  "
  replace scale of the specified Deployment"
  ([name string?, namespace string?, body v1beta2/scale, ] (replace-namespaced-deployment-scale_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/scale, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-deployment-scale_0 v1beta2/scale-spec
  "
  replace scale of the specified Deployment"
  ([name string?, namespace string?, body v1beta2/scale, ] (replace-namespaced-deployment-scale_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/scale, optional-params any?]
   (let [res (:data (replace-namespaced-deployment-scale_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/scale-spec res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-deployment-status apps/v1beta1/deployment-spec
  "
  replace status of the specified Deployment"
...
(defn-spec replace-namespaced-deployment-status_0-with-http-info any?
  "
  replace status of the specified Deployment"
  ([name string?, namespace string?, body v1beta2/deployment, ] (replace-namespaced-deployment-status_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/deployment, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-deployment-status_0 v1beta2/deployment-spec
  "
  replace status of the specified Deployment"
  ([name string?, namespace string?, body v1beta2/deployment, ] (replace-namespaced-deployment-status_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/deployment, optional-params any?]
   (let [res (:data (replace-namespaced-deployment-status_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))


(defn-spec replace-namespaced-deployment_0-with-http-info any?
  "
  replace the specified Deployment"
  ([name string?, namespace string?, body v1beta2/deployment, ] (replace-namespaced-deployment_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/deployment, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-deployment_0 v1beta2/deployment-spec
  "
  replace the specified Deployment"
  ([name string?, namespace string?, body v1beta2/deployment, ] (replace-namespaced-deployment_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/deployment, optional-params any?]
   (let [res (:data (replace-namespaced-deployment_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/deployment-spec res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-replica-set-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta2/replica-set, ] (replace-namespaced-replica-set-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/replica-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-replica-set v1beta2/replica-set-spec
  "
  replace the specified ReplicaSet"
  ([name string?, namespace string?, body v1beta2/replica-set, ] (replace-namespaced-replica-set name namespace body nil))
  ([name string?, namespace string?, body v1beta2/replica-set, optional-params any?]
...
(defn-spec replace-namespaced-replica-set-scale-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta2/scale, ] (replace-namespaced-replica-set-scale-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/scale, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-replica-set-scale v1beta2/scale-spec
  "
  replace scale of the specified ReplicaSet"
  ([name string?, namespace string?, body v1beta2/scale, ] (replace-namespaced-replica-set-scale name namespace body nil))
  ([name string?, namespace string?, body v1beta2/scale, optional-params any?]
...
(defn-spec replace-namespaced-replica-set-status-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta2/replica-set, ] (replace-namespaced-replica-set-status-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/replica-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-replica-set-status v1beta2/replica-set-spec
  "
  replace status of the specified ReplicaSet"
  ([name string?, namespace string?, body v1beta2/replica-set, ] (replace-namespaced-replica-set-status name namespace body nil))
  ([name string?, namespace string?, body v1beta2/replica-set, optional-params any?]
...
(defn-spec replace-namespaced-stateful-set-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/stateful-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-stateful-set v1beta1/stateful-set-spec
  "
  replace the specified StatefulSet"
...
(defn-spec replace-namespaced-stateful-set-scale apps/v1beta1/scale-spec
  "
  replace scale of the specified StatefulSet"
...
(defn-spec replace-namespaced-stateful-set-scale_0-with-http-info any?
  "
  replace scale of the specified StatefulSet"
  ([name string?, namespace string?, body v1beta2/scale, ] (replace-namespaced-stateful-set-scale_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/scale, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-stateful-set-scale_0 v1beta2/scale-spec
  "
  replace scale of the specified StatefulSet"
  ([name string?, namespace string?, body v1beta2/scale, ] (replace-namespaced-stateful-set-scale_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/scale, optional-params any?]
   (let [res (:data (replace-namespaced-stateful-set-scale_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/scale-spec res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-stateful-set-status v1beta1/stateful-set-spec
  "
  replace status of the specified StatefulSet"
...
(defn-spec replace-namespaced-stateful-set-status_0-with-http-info any?
  "
  replace status of the specified StatefulSet"
  ([name string?, namespace string?, body v1beta2/stateful-set, ] (replace-namespaced-stateful-set-status_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/stateful-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-stateful-set-status_0 v1beta2/stateful-set-spec
  "
  replace status of the specified StatefulSet"
  ([name string?, namespace string?, body v1beta2/stateful-set, ] (replace-namespaced-stateful-set-status_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/stateful-set, optional-params any?]
   (let [res (:data (replace-namespaced-stateful-set-status_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))


(defn-spec replace-namespaced-stateful-set_0-with-http-info any?
  "
  replace the specified StatefulSet"
  ([name string?, namespace string?, body v1beta2/stateful-set, ] (replace-namespaced-stateful-set_0-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1beta2/stateful-set, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-stateful-set_0 v1beta2/stateful-set-spec
  "
  replace the specified StatefulSet"
  ([name string?, namespace string?, body v1beta2/stateful-set, ] (replace-namespaced-stateful-set_0 name namespace body nil))
  ([name string?, namespace string?, body v1beta2/stateful-set, optional-params any?]
   (let [res (:data (replace-namespaced-stateful-set_0-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta2/stateful-set-spec res st/string-transformer)
        res))))
