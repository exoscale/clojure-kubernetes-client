...
(defn-spec create-cluster-role-with-http-info any?
  ...
  ([body v1beta1/cluster-role, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-cluster-role-binding-with-http-info any?
  ...
  ([body v1beta1/cluster-role-binding, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
...
(defn-spec create-namespaced-role-with-http-info any?
  ...
  ([namespace string?, body v1beta1/role, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-role-binding-with-http-info any?
  ...
  ([namespace string?, body v1beta1/role-binding, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec replace-cluster-role-with-http-info any?
  ...
  ([name string?, body v1beta1/cluster-role, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-cluster-role-binding-with-http-info any?
  ...
  ([name string?, body v1beta1/cluster-role-binding, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-namespaced-role-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/role, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-role-binding-with-http-info any?
  ...
  ([name string?, namespace string?, body v1beta1/role-binding, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
