(ns kubernetes.api.auditregistration-v1alpha1
...
(defn-spec create-audit-sink v1alpha1/audit-sink-spec
  "
  create an AuditSink"
  ...
  ([body v1alpha1/audit-sink, optional-params any?]
   (let [res (:data (create-audit-sink-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/audit-sink-spec res st/string-transformer)
        res))))
...
(defn-spec delete-audit-sink v1/status-spec
  "
  delete an AuditSink"
...
(defn-spec delete-collection-audit-sink v1/status-spec
  "
  delete collection of AuditSink"
...
(defn-spec list-audit-sink v1alpha1/audit-sink-list-spec
  "
  list or watch objects of kind AuditSink"
  ([] (list-audit-sink nil))
  ([optional-params any?]
   (let [res (:data (list-audit-sink-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/audit-sink-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-audit-sink v1alpha1/audit-sink-spec
  "
  partially update the specified AuditSink"
...
(defn-spec read-audit-sink v1alpha1/audit-sink-spec
  "
  read the specified AuditSink"
...
(defn-spec replace-audit-sink v1alpha1/audit-sink-spec
  "
  replace the specified AuditSink"
