(ns kubernetes.api.coordination-v1
...
(defn-spec create-namespaced-lease-with-http-info any?
  "
  create a Lease"
  ([namespace string?, body v1/lease, ] (create-namespaced-lease-with-http-info namespace body nil))
  ([namespace string?, body v1/lease, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-lease v1/lease-spec
  "
  create a Lease"
  ([namespace string?, body v1/lease, ] (create-namespaced-lease namespace body nil))
  ([namespace string?, body v1/lease, optional-params any?]
   (let [res (:data (create-namespaced-lease-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/lease-spec res st/string-transformer)
        res))))
...
(defn-spec list-lease-for-all-namespaces v1/lease-list-spec
  "
  list or watch objects of kind Lease"
  ...
  ([optional-params any?]
   (let [res (:data (list-lease-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/lease-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-lease v1/lease-list-spec
  "
  list or watch objects of kind Lease"
...
(defn-spec patch-namespaced-lease v1/lease-spec
  "
  partially update the specified Lease"
...
(defn-spec read-namespaced-lease v1/lease-spec
  "
  read the specified Lease"
...
(defn-spec replace-namespaced-lease-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/lease, ] (replace-namespaced-lease-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1/lease, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-lease v1/lease-spec
  "
  replace the specified Lease"
  ([name string?, namespace string?, body v1/lease, ] (replace-namespaced-lease name namespace body nil))
  ([name string?, namespace string?, body v1/lease, optional-params any?]
