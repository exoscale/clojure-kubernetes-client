...
(defn-spec create-namespaced-controller-revision v1/controller-revision-spec
  "
  create a ControllerRevision"
  ...
  ([namespace string?, body v1/controller-revision, optional-params any?]
   (let [res (:data (create-namespaced-controller-revision-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/controller-revision-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-daemon-set v1/daemon-set-spec
  "
  create a DaemonSet"
  ...
  ([namespace string?, body v1/daemon-set, optional-params any?]
   (let [res (:data (create-namespaced-daemon-set-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/daemon-set-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-deployment v1/deployment-spec
  "
  create a Deployment"
  ...
  ([namespace string?, body v1/deployment, optional-params any?]
   (let [res (:data (create-namespaced-deployment-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/deployment-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-replica-set v1/replica-set-spec
  "
  create a ReplicaSet"
  ...
  ([namespace string?, body v1/replica-set, optional-params any?]
   (let [res (:data (create-namespaced-replica-set-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/replica-set-spec res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-stateful-set v1/stateful-set-spec
  "
  create a StatefulSet"
  ...
  ([namespace string?, body v1/stateful-set, optional-params any?]
   (let [res (:data (create-namespaced-stateful-set-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/stateful-set-spec res st/string-transformer)
        res))))
...
(defn-spec list-controller-revision-for-all-namespaces v1/controller-revision-list-spec
  "
  list or watch objects of kind ControllerRevision"
  ...
  ([optional-params any?]
   (let [res (:data (list-controller-revision-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/controller-revision-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-daemon-set-for-all-namespaces v1/daemon-set-list-spec
  "
  list or watch objects of kind DaemonSet"
  ...
  ([optional-params any?]
   (let [res (:data (list-daemon-set-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/daemon-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-deployment-for-all-namespaces v1/deployment-list-spec
  "
  list or watch objects of kind Deployment"
  ...
  ([optional-params any?]
   (let [res (:data (list-deployment-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/deployment-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-controller-revision v1/controller-revision-list-spec
  "
  list or watch objects of kind ControllerRevision"
...
(defn-spec list-namespaced-daemon-set v1/daemon-set-list-spec
  "
  list or watch objects of kind DaemonSet"
...
(defn-spec list-namespaced-deployment v1/deployment-list-spec
  "
  list or watch objects of kind Deployment"
...
(defn-spec list-namespaced-replica-set v1/replica-set-list-spec
  "
  list or watch objects of kind ReplicaSet"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-replica-set-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/replica-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-stateful-set v1/stateful-set-list-spec
  "
  list or watch objects of kind StatefulSet"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-stateful-set-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/stateful-set-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-replica-set-for-all-namespaces v1/replica-set-list-spec
  "
  list or watch objects of kind ReplicaSet"
...
(defn-spec list-stateful-set-for-all-namespaces v1/stateful-set-list-spec
  "
  list or watch objects of kind StatefulSet"
...
(defn-spec patch-namespaced-controller-revision v1/controller-revision-spec
  "
  partially update the specified ControllerRevision"
...
(defn-spec patch-namespaced-daemon-set v1/daemon-set-spec
  "
  partially update the specified DaemonSet"
...
(defn-spec patch-namespaced-daemon-set-status v1/daemon-set-spec
  "
  partially update status of the specified DaemonSet"
...
(defn-spec patch-namespaced-deployment v1/deployment-spec
  "
  partially update the specified Deployment"
...
(defn-spec patch-namespaced-deployment-scale v1/scale-spec
  "
  partially update scale of the specified Deployment"
...
(defn-spec patch-namespaced-deployment-status v1/deployment-spec
  "
  partially update status of the specified Deployment"
...
(defn-spec patch-namespaced-replica-set v1/replica-set-spec
  "
  partially update the specified ReplicaSet"
...
(defn-spec patch-namespaced-replica-set-scale v1/scale-spec
  "
  partially update scale of the specified ReplicaSet"
...
(defn-spec patch-namespaced-replica-set-status v1/replica-set-spec
  "
  partially update status of the specified ReplicaSet"
...
(defn-spec patch-namespaced-stateful-set v1/stateful-set-spec
  "
  partially update the specified StatefulSet"
...
(defn-spec patch-namespaced-stateful-set-scale v1/scale-spec
  "
  partially update scale of the specified StatefulSet"
...
(defn-spec patch-namespaced-stateful-set-status v1/stateful-set-spec
  "
  partially update status of the specified StatefulSet"
...
(defn-spec read-namespaced-controller-revision v1/controller-revision-spec
  "
  read the specified ControllerRevision"
...
(defn-spec read-namespaced-daemon-set v1/daemon-set-spec
  "
  read the specified DaemonSet"
...
(defn-spec read-namespaced-daemon-set-status v1/daemon-set-spec
  "
  read status of the specified DaemonSet"
...
(defn-spec read-namespaced-deployment v1/deployment-spec
  "
  read the specified Deployment"
...
(defn-spec read-namespaced-deployment-scale v1/scale-spec
  "
  read scale of the specified Deployment"
...
(defn-spec read-namespaced-deployment-status v1/deployment-spec
  "
  read status of the specified Deployment"
...
(defn-spec read-namespaced-replica-set v1/replica-set-spec
  "
  read the specified ReplicaSet"
...
(defn-spec read-namespaced-replica-set-scale v1/scale-spec
  "
  read scale of the specified ReplicaSet"
...
(defn-spec read-namespaced-replica-set-status v1/replica-set-spec
  "
  read status of the specified ReplicaSet"
...
(defn-spec read-namespaced-stateful-set v1/stateful-set-spec
  "
  read the specified StatefulSet"
...
(defn-spec read-namespaced-stateful-set-scale v1/scale-spec
  "
  read scale of the specified StatefulSet"
...
(defn-spec read-namespaced-stateful-set-status v1/stateful-set-spec
  "
  read status of the specified StatefulSet"
...
(defn-spec replace-namespaced-controller-revision v1/controller-revision-spec
  "
  replace the specified ControllerRevision"
...
(defn-spec replace-namespaced-daemon-set v1/daemon-set-spec
  "
  replace the specified DaemonSet"
...
(defn-spec replace-namespaced-daemon-set-status v1/daemon-set-spec
  "
  replace status of the specified DaemonSet"
...
(defn-spec replace-namespaced-deployment v1/deployment-spec
  "
  replace the specified Deployment"
...
(defn-spec replace-namespaced-deployment-scale v1/scale-spec
  "
  replace scale of the specified Deployment"
...
(defn-spec replace-namespaced-deployment-status v1/deployment-spec
  "
  replace status of the specified Deployment"
...
(defn-spec replace-namespaced-replica-set v1/replica-set-spec
  "
  replace the specified ReplicaSet"
...
(defn-spec replace-namespaced-replica-set-scale v1/scale-spec
  "
  replace scale of the specified ReplicaSet"
...
(defn-spec replace-namespaced-replica-set-status v1/replica-set-spec
  "
  replace status of the specified ReplicaSet"
...
(defn-spec replace-namespaced-stateful-set v1/stateful-set-spec
  "
  replace the specified StatefulSet"
...
(defn-spec replace-namespaced-stateful-set-scale v1/scale-spec
  "
  replace scale of the specified StatefulSet"
...
(defn-spec replace-namespaced-stateful-set-status v1/stateful-set-spec
  "
  replace status of the specified StatefulSet"
