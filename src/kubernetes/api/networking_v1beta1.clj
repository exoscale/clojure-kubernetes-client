(ns kubernetes.api.networking-v1beta1
...
(defn-spec create-namespaced-ingress networking/v1beta1/ingress-spec
  "
  create an Ingress"
  ...
  ([namespace string?, body networking/v1beta1/ingress, optional-params any?]
   (let [res (:data (create-namespaced-ingress-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode networking/v1beta1/ingress-spec res st/string-transformer)
        res))))
...
(defn-spec list-ingress-for-all-namespaces networking/v1beta1/ingress-list-spec
  "
  list or watch objects of kind Ingress"
  ...
  ([optional-params any?]
   (let [res (:data (list-ingress-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode networking/v1beta1/ingress-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-ingress networking/v1beta1/ingress-list-spec
  "
  list or watch objects of kind Ingress"
...
(defn-spec patch-namespaced-ingress networking/v1beta1/ingress-spec
  "
  partially update the specified Ingress"
...
(defn-spec patch-namespaced-ingress-status networking/v1beta1/ingress-spec
  "
  partially update status of the specified Ingress"
...
(defn-spec read-namespaced-ingress networking/v1beta1/ingress-spec
  "
  read the specified Ingress"
...
(defn-spec read-namespaced-ingress-status networking/v1beta1/ingress-spec
  "
  read status of the specified Ingress"
...
(defn-spec replace-namespaced-ingress networking/v1beta1/ingress-spec
  "
  replace the specified Ingress"
...
(defn-spec replace-namespaced-ingress-status networking/v1beta1/ingress-spec
  "
  replace status of the specified Ingress"
