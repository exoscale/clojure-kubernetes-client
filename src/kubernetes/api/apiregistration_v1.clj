(ns kubernetes.api.apiregistration-v1
...
(defn-spec create-api-service-with-http-info any?
  ...
  ([body v1/api-service, ] (create-api-service-with-http-info body nil))
  ([body v1/api-service, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-api-service v1/api-service-spec
  "
  create an APIService"
  ([body v1/api-service, ] (create-api-service body nil))
  ([body v1/api-service, optional-params any?]
   (let [res (:data (create-api-service-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/api-service-spec res st/string-transformer)
        res))))
...
(defn-spec delete-api-service v1/status-spec
  "
  delete an APIService"
...
(defn-spec delete-collection-api-service v1/status-spec
  "
  delete collection of APIService"
...
(defn-spec list-api-service v1/api-service-list-spec
  "
  list or watch objects of kind APIService"
  ...
  ([optional-params any?]
   (let [res (:data (list-api-service-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/api-service-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-api-service v1/api-service-spec
  "
  partially update the specified APIService"
...
(defn-spec patch-api-service-status v1/api-service-spec
  "
  partially update status of the specified APIService"
...
(defn-spec read-api-service v1/api-service-spec
  "
  read the specified APIService"
...
(defn-spec read-api-service-status v1/api-service-spec
  "
  read status of the specified APIService"
...
(defn-spec replace-api-service-with-http-info any?
  ...
  ([name string?, body v1/api-service, ] (replace-api-service-with-http-info name body nil))
  ([name string?, body v1/api-service, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-api-service v1/api-service-spec
  "
  replace the specified APIService"
  ([name string?, body v1/api-service, ] (replace-api-service name body nil))
  ([name string?, body v1/api-service, optional-params any?]
...
(defn-spec replace-api-service-status-with-http-info any?
  ...
  ([name string?, body v1/api-service, ] (replace-api-service-status-with-http-info name body nil))
  ([name string?, body v1/api-service, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-api-service-status v1/api-service-spec
  "
  replace status of the specified APIService"
  ([name string?, body v1/api-service, ] (replace-api-service-status name body nil))
  ([name string?, body v1/api-service, optional-params any?]
