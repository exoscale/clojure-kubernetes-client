(ns kubernetes.api.scheduling-v-alpha-
...
(defn-spec create-priority-class-with-http-info any?
  ...
  ([body v1alpha1/priority-class, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-priority-class v1alpha1/priority-class-spec
  "
  create a PriorityClass"
  ...
  ([body v1alpha1/priority-class, optional-params any?]
   (let [res (:data (create-priority-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/priority-class-spec res st/string-transformer)
        res))))
...
(defn-spec delete-priority-class-with-http-info any?
  ...
  ([name string?, body v1/delete-options, ] (delete-priority-class-with-http-info name body nil))
...
(defn-spec delete-priority-class v1/status-spec
  "
  delete a PriorityClass"
  ([name string?, body v1/delete-options, ] (delete-priority-class name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-priority-class-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec list-priority-class v1alpha1/priority-class-list-spec
  "
  list or watch objects of kind PriorityClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-priority-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/priority-class-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-priority-class v1alpha1/priority-class-spec
  "
  partially update the specified PriorityClass"
...
(defn-spec read-priority-class v1alpha1/priority-class-spec
  "
  read the specified PriorityClass"
...
(defn-spec replace-priority-class-with-http-info any?
  ...
  ([name string?, body v1alpha1/priority-class, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-priority-class v1alpha1/priority-class-spec
  "
  replace the specified PriorityClass"
