...
(defn-spec create-storage-class v1/storage-class-spec
  "
  create a StorageClass"
  ...
  ([body v1/storage-class, optional-params any?]
   (let [res (:data (create-storage-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/storage-class-spec res st/string-transformer)
        res))))
...
(defn-spec create-volume-attachment v1/volume-attachment-spec
  "
  create a VolumeAttachment"
  ...
  ([body v1/volume-attachment, optional-params any?]
   (let [res (:data (create-volume-attachment-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/volume-attachment-spec res st/string-transformer)
        res))))
...
(defn-spec list-storage-class v1/storage-class-list-spec
  "
  list or watch objects of kind StorageClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-storage-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/storage-class-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-volume-attachment v1/volume-attachment-list-spec
  "
  list or watch objects of kind VolumeAttachment"
  ...
  ([optional-params any?]
   (let [res (:data (list-volume-attachment-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/volume-attachment-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-storage-class v1/storage-class-spec
  "
  partially update the specified StorageClass"
...
(defn-spec patch-volume-attachment v1/volume-attachment-spec
  "
  partially update the specified VolumeAttachment"
...
(defn-spec patch-volume-attachment-status v1/volume-attachment-spec
  "
  partially update status of the specified VolumeAttachment"
...
(defn-spec read-storage-class v1/storage-class-spec
  "
  read the specified StorageClass"
...
(defn-spec read-volume-attachment v1/volume-attachment-spec
  "
  read the specified VolumeAttachment"
...
(defn-spec read-volume-attachment-status v1/volume-attachment-spec
  "
  read status of the specified VolumeAttachment"
...
(defn-spec replace-storage-class v1/storage-class-spec
  "
  replace the specified StorageClass"
...
(defn-spec replace-volume-attachment v1/volume-attachment-spec
  "
  replace the specified VolumeAttachment"
...
(defn-spec replace-volume-attachment-status v1/volume-attachment-spec
  "
  replace status of the specified VolumeAttachment"
