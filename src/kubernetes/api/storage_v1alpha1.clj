(ns kubernetes.api.storage-v1alpha1
...
(defn-spec create-volume-attachment v1alpha1/volume-attachment-spec
  "
  create a VolumeAttachment"
  ...
  ([body v1alpha1/volume-attachment, optional-params any?]
   (let [res (:data (create-volume-attachment-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/volume-attachment-spec res st/string-transformer)
        res))))
...
(defn-spec list-volume-attachment v1alpha1/volume-attachment-list-spec
  "
  list or watch objects of kind VolumeAttachment"
  ...
  ([optional-params any?]
   (let [res (:data (list-volume-attachment-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/volume-attachment-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-volume-attachment v1alpha1/volume-attachment-spec
  "
  partially update the specified VolumeAttachment"
...
(defn-spec read-volume-attachment v1alpha1/volume-attachment-spec
  "
  read the specified VolumeAttachment"
...
(defn-spec replace-volume-attachment v1alpha1/volume-attachment-spec
  "
  replace the specified VolumeAttachment"
