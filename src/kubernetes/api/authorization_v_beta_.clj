...
(defn-spec create-namespaced-local-subject-access-review-with-http-info any?
  ...
  ([namespace string?, body v1beta1/local-subject-access-review, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-self-subject-access-review-with-http-info any?
  ...
  ([body v1beta1/self-subject-access-review, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-self-subject-rules-review-with-http-info any?
  ...
  ([body v1beta1/self-subject-rules-review, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
...
(defn-spec create-subject-access-review-with-http-info any?
  ...
  ([body v1beta1/subject-access-review, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params body)
