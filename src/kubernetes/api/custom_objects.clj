(ns kubernetes.api.custom-objects
...
(defn-spec delete-cluster-custom-object-with-http-info any?
  ...
  ([group string?, version string?, plural string?, name string?, body v1/delete-options, ] (delete-cluster-custom-object-with-http-info group version plural name body nil))
  ([group string?, version string?, plural string?, name string?, body v1/delete-options, {:keys [gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
...
(defn-spec delete-cluster-custom-object any?
  "
  Deletes the specified cluster scoped custom object"
  ([group string?, version string?, plural string?, name string?, body v1/delete-options, ] (delete-cluster-custom-object group version plural name body nil))
  ([group string?, version string?, plural string?, name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-cluster-custom-object-with-http-info group version plural name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-custom-object-with-http-info any?
  ...
  ([group string?, version string?, namespace string?, plural string?, name string?, body v1/delete-options, ] (delete-namespaced-custom-object-with-http-info group version namespace plural name body nil))
  ([group string?, version string?, namespace string?, plural string?, name string?, body v1/delete-options, {:keys [gracePeriodSeconds orphanDependents propagationPolicy]} (s/map-of keyword? any?)]
...
(defn-spec delete-namespaced-custom-object any?
  "
  Deletes the specified namespace scoped custom object"
  ([group string?, version string?, namespace string?, plural string?, name string?, body v1/delete-options, ] (delete-namespaced-custom-object group version namespace plural name body nil))
  ([group string?, version string?, namespace string?, plural string?, name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-namespaced-custom-object-with-http-info group version namespace plural name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode any? res st/string-transformer)
        res))))
...
(defn-spec list-cluster-custom-object-with-http-info any?
  ...
  ([group string?, version string?, plural string?, {:keys [pretty fieldSelector labelSelector resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (check-required-params group version plural)
   (call-api "/apis/{group}/{version}/{plural}" :get
             {:path-params   {"group" group "version" version "plural" plural }
              :header-params {}
              :query-params  {"pretty" pretty "fieldSelector" fieldSelector "labelSelector" labelSelector "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
              :content-types []
...
(defn-spec list-namespaced-custom-object-with-http-info any?
  ...
  ([group string?, version string?, namespace string?, plural string?, {:keys [pretty fieldSelector labelSelector resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
