(ns kubernetes.api.events-v1beta1
...
(defn-spec create-namespaced-event v1beta1/event-spec
  "
  create an Event"
  ...
  ([namespace string?, body v1beta1/event, optional-params any?]
   (let [res (:data (create-namespaced-event-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/event-spec res st/string-transformer)
        res))))
...
(defn-spec list-event-for-all-namespaces v1beta1/event-list-spec
  "
  list or watch objects of kind Event"
  ...
  ([optional-params any?]
   (let [res (:data (list-event-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/event-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-event v1beta1/event-list-spec
  "
  list or watch objects of kind Event"
...
(defn-spec patch-namespaced-event v1beta1/event-spec
  "
  partially update the specified Event"
...
(defn-spec read-namespaced-event v1beta1/event-spec
  "
  read the specified Event"
...
(defn-spec replace-namespaced-event v1beta1/event-spec
  "
  replace the specified Event"
