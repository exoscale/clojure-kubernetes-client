(ns kubernetes.api.certificates-v1beta1
...
(defn-spec patch-certificate-signing-request-status v1beta1/certificate-signing-request-spec
  "
  partially update status of the specified CertificateSigningRequest"
...
(defn-spec read-certificate-signing-request-status v1beta1/certificate-signing-request-spec
  "
  read status of the specified CertificateSigningRequest"
