(ns kubernetes.api.apiregistration-v1beta1
...
(defn-spec patch-api-service-status v1beta1/api-service-spec
  "
  partially update status of the specified APIService"
...
(defn-spec read-api-service-status v1beta1/api-service-spec
  "
  read status of the specified APIService"
