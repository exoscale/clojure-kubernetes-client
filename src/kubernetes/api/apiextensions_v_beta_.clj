...
(defn-spec create-custom-resource-definition-with-http-info any?
  ...
  ([body v1beta1/custom-resource-definition, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-custom-resource-definition v1beta1/custom-resource-definition-spec
  "
  create a CustomResourceDefinition"
  ...
  ([body v1beta1/custom-resource-definition, optional-params any?]
   (let [res (:data (create-custom-resource-definition-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/custom-resource-definition-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-custom-resource-definition v1/status-spec
  "
  delete collection of CustomResourceDefinition"
...
(defn-spec delete-custom-resource-definition-with-http-info any?
  ...
  ([name string?, body v1/delete-options, ] (delete-custom-resource-definition-with-http-info name body nil))
...
(defn-spec delete-custom-resource-definition v1/status-spec
  "
  delete a CustomResourceDefinition"
  ([name string?, body v1/delete-options, ] (delete-custom-resource-definition name body nil))
  ([name string?, body v1/delete-options, optional-params any?]
   (let [res (:data (delete-custom-resource-definition-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/status-spec res st/string-transformer)
        res))))
...
(defn-spec list-custom-resource-definition v1beta1/custom-resource-definition-list-spec
  "
  list or watch objects of kind CustomResourceDefinition"
  ...
  ([optional-params any?]
   (let [res (:data (list-custom-resource-definition-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/custom-resource-definition-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-custom-resource-definition v1beta1/custom-resource-definition-spec
  "
  partially update the specified CustomResourceDefinition"
...
(defn-spec read-custom-resource-definition v1beta1/custom-resource-definition-spec
  "
  read the specified CustomResourceDefinition"
...
(defn-spec replace-custom-resource-definition-with-http-info any?
  ...
  ([name string?, body v1beta1/custom-resource-definition, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-custom-resource-definition v1beta1/custom-resource-definition-spec
  "
  replace the specified CustomResourceDefinition"
...
(defn-spec replace-custom-resource-definition-status v1beta1/custom-resource-definition-spec
  "
  replace status of the specified CustomResourceDefinition"
