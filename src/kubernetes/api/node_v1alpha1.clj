(ns kubernetes.api.node-v1alpha1
...
(defn-spec create-runtime-class v1alpha1/runtime-class-spec
  "
  create a RuntimeClass"
  ...
  ([body v1alpha1/runtime-class, optional-params any?]
   (let [res (:data (create-runtime-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/runtime-class-spec res st/string-transformer)
        res))))
...
(defn-spec list-runtime-class v1alpha1/runtime-class-list-spec
  "
  list or watch objects of kind RuntimeClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-runtime-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1/runtime-class-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-runtime-class v1alpha1/runtime-class-spec
  "
  partially update the specified RuntimeClass"
...
(defn-spec read-runtime-class v1alpha1/runtime-class-spec
  "
  read the specified RuntimeClass"
...
(defn-spec replace-runtime-class v1alpha1/runtime-class-spec
  "
  replace the specified RuntimeClass"
