(ns kubernetes.api.node-v1beta1
...
(defn-spec create-runtime-class-with-http-info any?
  ...
  ([body v1beta1/runtime-class, ] (create-runtime-class-with-http-info body nil))
  ([body v1beta1/runtime-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec create-runtime-class v1beta1/runtime-class-spec
  "
  create a RuntimeClass"
  ([body v1beta1/runtime-class, ] (create-runtime-class body nil))
  ([body v1beta1/runtime-class, optional-params any?]
   (let [res (:data (create-runtime-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/runtime-class-spec res st/string-transformer)
        res))))
...
(defn-spec delete-collection-runtime-class-with-http-info any?
  ...
  ([{:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses" :delete
             {:path-params   {}
              :header-params {}
...
(defn-spec delete-collection-runtime-class v1/status-spec
  "
  delete collection of RuntimeClass"
...
(defn-spec delete-runtime-class-with-http-info any?
  ...
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses/{name}" :delete
...
(defn-spec delete-runtime-class v1/status-spec
  "
  delete a RuntimeClass"
...
(defn-spec get-api-resources-with-http-info any?
  ...
  []
  (call-api "/apis/node.k8s.io/v1beta1/" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec list-runtime-class-with-http-info any?
  ...
  ([{:keys [pretty continue fieldSelector labelSelector limit resourceVersion timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-runtime-class v1beta1/runtime-class-list-spec
  "
  list or watch objects of kind RuntimeClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-runtime-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/runtime-class-list-spec res st/string-transformer)
        res))))
...
(defn-spec patch-runtime-class-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec patch-runtime-class v1beta1/runtime-class-spec
  "
  partially update the specified RuntimeClass"
...
(defn-spec read-runtime-class-with-http-info any?
  ...
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-runtime-class v1beta1/runtime-class-spec
  "
  read the specified RuntimeClass"
...
(defn-spec replace-runtime-class-with-http-info any?
  ...
  ([name string?, body v1beta1/runtime-class, ] (replace-runtime-class-with-http-info name body nil))
  ([name string?, body v1beta1/runtime-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/node.k8s.io/v1beta1/runtimeclasses/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-runtime-class v1beta1/runtime-class-spec
  "
  replace the specified RuntimeClass"
  ([name string?, body v1beta1/runtime-class, ] (replace-runtime-class name body nil))
  ([name string?, body v1beta1/runtime-class, optional-params any?]
