(ns kubernetes.api.authorization-v1beta1
...
(defn-spec create-namespaced-local-subject-access-review v1beta1/local-subject-access-review-spec
  "
  create a LocalSubjectAccessReview"
  ...
  ([namespace string?, body v1beta1/local-subject-access-review, optional-params any?]
   (let [res (:data (create-namespaced-local-subject-access-review-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/local-subject-access-review-spec res st/string-transformer)
        res))))
...
(defn-spec create-self-subject-access-review v1beta1/self-subject-access-review-spec
  "
  create a SelfSubjectAccessReview"
  ...
  ([body v1beta1/self-subject-access-review, optional-params any?]
   (let [res (:data (create-self-subject-access-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/self-subject-access-review-spec res st/string-transformer)
        res))))
...
(defn-spec create-self-subject-rules-review v1beta1/self-subject-rules-review-spec
  "
  create a SelfSubjectRulesReview"
  ...
  ([body v1beta1/self-subject-rules-review, optional-params any?]
   (let [res (:data (create-self-subject-rules-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/self-subject-rules-review-spec res st/string-transformer)
        res))))
...
(defn-spec create-subject-access-review v1beta1/subject-access-review-spec
  "
  create a SubjectAccessReview"
  ...
  ([body v1beta1/subject-access-review, optional-params any?]
   (let [res (:data (create-subject-access-review-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1/subject-access-review-spec res st/string-transformer)
        res))))
