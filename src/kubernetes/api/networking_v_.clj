...
(defn-spec create-namespaced-network-policy-with-http-info any?
  ...
  ([namespace string?, body v1/network-policy, {:keys [pretty]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-network-policy v1/network-policy-spec
  "
  create a NetworkPolicy"
  ...
  ([namespace string?, body v1/network-policy, optional-params any?]
   (let [res (:data (create-namespaced-network-policy-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/network-policy-spec res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-network-policy v1/network-policy-list-spec
  "
  list or watch objects of kind NetworkPolicy"
  ...
  ([namespace string?, optional-params any?]
   (let [res (:data (list-namespaced-network-policy-with-http-info namespace optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1/network-policy-list-spec res st/string-transformer)
        res))))
...
(defn-spec list-network-policy-for-all-namespaces v1/network-policy-list-spec
  "
  list or watch objects of kind NetworkPolicy"
...
(defn-spec patch-namespaced-network-policy v1/network-policy-spec
  "
  partially update the specified NetworkPolicy"
...
(defn-spec read-namespaced-network-policy v1/network-policy-spec
  "
  read the specified NetworkPolicy"
...
(defn-spec replace-namespaced-network-policy-with-http-info any?
  ...
  ([name string?, namespace string?, body v1/network-policy, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-network-policy v1/network-policy-spec
  "
  replace the specified NetworkPolicy"
